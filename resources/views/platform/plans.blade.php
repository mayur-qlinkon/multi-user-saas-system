    ...
    <div class="pb-10" x-data="planManager(@js($plans), @js($modules))">
            ...
            @forelse ($plans as $plan)
                <div
                    ...
                    <div class="p-6 border-b border-gray-100 bg-gray-50/50">
                        <h3 class="text-lg font-black text-gray-800 mb-1">{{ $plan->name }}</h3>
                        <div class="flex items-baseline gap-1">
                            <span class="text-3xl font-black text-brand-600">₹{{ number_format($plan->price, 0) }}</span>
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-6">
                            <div class="bg-gray-50 rounded-lg p-3 border border-gray-100">
                                ...
                                <p class="text-lg font-black text-gray-700">{{ $plan->user_limit }}</p>
                            </div>
                            <div class="bg-gray-50 rounded-lg p-3 border border-gray-100">
                                <p class="text-[10px] text-gray-400 font-bold uppercase tracking-wider mb-1">Stores</p>
                                <p class="text-lg font-black text-gray-700">{{ $plan->store_limit }}</p>
                            </div>
                        </div>
        ...
        <div x-cloak x-show="showFormModal" class="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]"
                ...
                <form :action="isEditing ? `/platform/plans/${form.id}` : '{{ route('platform.plans.store') }}'"
