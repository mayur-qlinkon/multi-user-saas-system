    ...
    <div class="space-y-8">
        ...
        <div class="bg-white rounded-xl border shadow-sm p-6">
            ...
            <div class="grid md:grid-cols-4 gap-4">
                <a href="{{ route('platform.plans.index') }}" class="border rounded-lg p-4 hover:bg-gray-50 transition">
                ...
                <a href="{{ route('platform.modules.index') }}" class="border rounded-lg p-4 hover:bg-gray-50 transition">
                    <div class="flex items-center gap-3">
                ...
                <a href="{{ route('platform.subscriptions.index') }}" class="border rounded-lg p-4 hover:bg-gray-50 transition">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 bg-green-100 text-green-600 rounded-lg flex items-center justify-center">
                            <i data-lucide="credit-card" class="w-5 h-5"></i>
                        </div>
                ...
                <a href="{{ route('platform.system.index') }}" class="border rounded-lg p-4 hover:bg-gray-50 transition">
                    <div class="flex items-center gap-3">
        ...
        <div class="bg-white rounded-xl border shadow-sm">
            <div class="p-6 border-b flex items-center justify-between">
                ...
                <a href="{{ route('platform.subscriptions.index') }}" class="text-sm text-brand-600 hover:underline">
                    View All
                </a>
            </div>
                    ...
                    <tbody class="divide-y">
                        @forelse ($recentSubscriptions as $subscription)
                            <tr>
                                ...
                                <td class="px-6 py-4">
                                    @if($subscription->is_active && $subscription->expires_at > now())
