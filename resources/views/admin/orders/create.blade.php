...
@section('content')
    ...
    <div class="pb-20" x-data="orderForm(@js($warehouses->where('is_default', 1)->pluck('id', 'store_id')), @js($clients ?? []))">
        ...
        <form id="mainOrderForm" action="{{ route('admin.orders.store') }}" method="POST" @submit="BizAlert.loading('Processing Order...')">
            @csrf
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <select name="warehouse_id" x-model="formData.warehouse_id" required class="w-full border border-gray-300 rounded px-3 py-2 text-sm outline-none bg-white">
                                ...
                                {{-- Load warehouses via Alpine or just inject here if available globally --}}
