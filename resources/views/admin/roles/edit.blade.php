...
@section('title', 'Edit Role - Qlinkon BIZNESS')
...
@section('content')
    ...
    {{-- Pass the $rolePermissions array from the Controller into Alpine's oldSelected parameter --}}
    <div class="pb-10" x-data="roleMatrixForm(@js(old('permissions', $rolePermissions)), @js($jsMatrix))">
        ...
        <div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-[13px] text-gray-500 font-medium">Modifying access permissions for: <span
                        class="font-bold text-[#108c2a]">{{ $role->name }}</span></p>
            </div>
