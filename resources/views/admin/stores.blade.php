...
@section('content')
    <div class="space-y-6 pb-10" x-data="storeCrud()">
            ...
            @forelse ($stores as $store)
                <div
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <div class="min-w-0">
                            <h3 class="text-lg font-bold text-[#212538] truncate">{{ $store->name }}</h3>
                    ...
                    <div class="flex items-center gap-2 pt-4 border-t border-gray-50">
                        <button
                            @click="openEditModal({{ $store->toJson() }}, '{{ $store->logo_url }}', '{{ $store->signature_url }}')"
        ...
        {{-- 🌟 OPTION A: THE PREMIUM "PROFILE & TWO-COLUMN" MODAL --}}
                ...
                <div
                    ...
                    <form :action="formAction" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="overflow-y-auto flex-1 custom-scrollbar bg-gray-50/30">
                            ...
                            {{-- SECTION 1: Identity Profile (Top) --}}
    ...
    <script>
        function storeCrud() {
            return {
                isModalOpen: false,
                modalMode: 'create',
                formAction: '{{ route('admin.stores.store') }}',
                logoPreview: null,
                formData: {
                    name: '',
                    gst_number: '',
                ...
                openCreateModal() {
                    ...
                    this.formAction = '{{ route('admin.stores.store') }}';
                    this.formData = {
                        name: '',
                        gst_number: '',
                        currency: 'INR',
