            ...
            <div class="section-body">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-4">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="employee@company.com" required
                    ...
                    <div>
                        ...
                        <select name="store_id" required class="field-input {{ $errors->has('store_id') ? 'has-error' : '' }}">
                            <option value="" disabled {{ old('store_id') ? '' : 'selected' }}>Select Primary Store</option>
                    ...
                    <div>
                        ...
                        <select name="salary_type" class="field-input {{ $errors->has('salary_type') ? 'has-error' : '' }}">
                            ...
                            @foreach(['monthly' => 'Monthly', 'daily' => 'Daily', 'hourly' => 'Hourly'] as $val => $label)
                                <option value="{{ $val }}" {{ old('salary_type') == $val ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                        @error('salary_type')
                            <p class="field-error">{{ $message }}</p>
            ...
            <div class="section-body">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_ifsc" value="{{ old('bank_ifsc') }}"
            ...
            <div class="section-body">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="uan_number" value="{{ old('uan_number') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="esi_number" value="{{ old('esi_number') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="pf_number" value="{{ old('pf_number') }}"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="current_address" rows="3"
                            ...
                            class="field-input resize-none {{ $errors->has('current_address') ? 'has-error' : '' }}">{{ old('current_address') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="permanent_address" rows="3"
                            ...
                            class="field-input resize-none {{ $errors->has('permanent_address') ? 'has-error' : '' }}">{{ old('permanent_address') }}</textarea>
        ...
        <div class="form-section">
            ...
            <div class="section-body">
                <textarea name="notes" rows="3"
                    ...
                    class="field-input resize-none w-full {{ $errors->has('notes') ? 'has-error' : '' }}">{{ old('notes') }}</textarea>
                @error('notes')
                    <p class="field-error">{{ $message }}</p>
                @enderror
            </div>
