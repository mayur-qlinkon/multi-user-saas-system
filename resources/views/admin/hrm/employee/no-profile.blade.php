...
<div class="flex items-center justify-center min-h-[60vh]">
    <div class="text-center max-w-md px-6">
        ...
        <div class="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 text-left mb-6">
            ...
            <p class="text-[12px] text-amber-800">Go to <strong>HRM → Employees → Create Employee</strong> and link your user account (<strong>{{ auth()->user()->name }}</strong>) to a new employee record.</p>
        </div>
