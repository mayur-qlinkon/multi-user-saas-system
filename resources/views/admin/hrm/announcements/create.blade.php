...
<div class="pb-12" x-data="announcementForm()">
    ...
    <form action="{{ route('admin.hrm.announcements.store') }}" method="POST" enctype="multipart/form-data" @submit="isSubmitting = true">
        @csrf
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea id="content" name="content" rows="10" required
                                ...
                                class="field-input resize-y min-h-[200px] @error('content') has-error @enderror">{{ old('content') }}</textarea>
                            @error('content')
                                <p class="field-error"><i data-lucide="alert-circle" class="w-3 h-3"></i> {{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="section-card">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" id="expire_at" name="expire_at" value="{{ old('expire_at') }}"
                ...
                <div class="section-card">
                    ...
                    <div class="space-y-5">
                        ...
                        <label class="relative flex items-start cursor-pointer group">
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="requires_acknowledgement" value="1" {{ old('requires_acknowledgement') ? 'checked' : '' }} class="sr-only peer">
...
window.announcementForm = function() {
    ...
    const oldIds = @json(old('target_ids', [])).map(Number);
