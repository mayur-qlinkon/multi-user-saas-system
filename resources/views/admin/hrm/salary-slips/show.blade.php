...
<div class="pb-10 w-full" x-data="salarySlipShow()">
            ...
            <div class="card-body !p-0">
                <table class="comp-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $item->component_name }}</td>
                            <td class="!text-red-600">₹{{ number_format($item->amount, 2) }}</td>
                        </tr>
                        @empty
                        <tr>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="detail-card">
                ...
                <div class="card-body">
                    <div class="info-row">
                        ...
                        <span class="info-value">₹{{ number_format($salarySlip->gross_salary, 2) }}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Total Deductions</span>
                        <span class="info-value text-red-600">— ₹{{ number_format($salarySlip->total_deductions, 2) }}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Round Off</span>
                        <span class="info-value text-gray-500">{{ $salarySlip->round_off >= 0 ? '+' : '' }}₹{{ number_format($salarySlip->round_off ?? 0, 2) }}</span>
                    </div>
                    <div class="mt-4 bg-gray-50 rounded-xl px-5 py-4 flex items-center justify-between">
                        ...
                        <p class="text-[26px] font-black text-gray-900">₹{{ number_format($salarySlip->net_salary, 2) }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-card">
                ...
                <div class="card-body">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value capitalize">{{ str_replace('_', ' ', $salarySlip->payment_mode) }}</span>
                    </div>
                    @endif
            ...
            {{-- Action Panel --}}
            @if(in_array($salarySlip->status, ['generated', 'approved']))
            <div class="detail-card">
                <div class="card-header">
