                ...
                <div class="text-right text-sm flex flex-col items-end">
                    ...
                    <div class="text-gray-600 text-[12px] mt-1">
                        @if ($company->gst_number || $company->gstin)
                            GSTIN: <span
                                class="font-bold text-gray-900 uppercase">{{ $company->gst_number ?? $company->gstin }}</span><br>
                        @endif
            ...
            <div
                ...
                <div class="w-full md:w-1/2 print:w-1/2 mb-6 md:mb-0 print:mb-0 space-y-6">
                    ...
                    <div class="flex flex-wrap items-start gap-8 pt-4 border-t border-gray-100">
                        {{-- Static Bank Details (Replace with your settings variables later if needed) --}}
                        <div>
                        ...
                        {{-- Dynamic UPI QR Code (Only show if there is a balance) --}}
                        @if ($balanceDue > 0)
                            <div>
