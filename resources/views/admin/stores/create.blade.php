...
@section('title', 'Add New Branch - Qlinkon BIZNESS')
...
@section('content')
    ...
    <div class="w-full mx-auto space-y-4 sm:space-y-6 pb-10" x-data="storeCreateForm()">
        ...
        {{-- Main Form --}}
        <form action="{{ route('admin.stores.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5 sm:space-y-6" @submit="isSubmitting = true">
            @csrf
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" required placeholder="e.g. Downtown Hub"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                            <div>
                                ...
                                <input type="text" name="gst_number" value="{{ old('gst_number') }}" placeholder="24AAAAA0000A1Z5" maxlength="15"
                            ...
                            <div>
                                ...
                                <input type="text" name="upi_id" value="{{ old('upi_id') }}" placeholder="store@bank"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                            </div>
                            <div>
                                ...
                                <select name="currency" class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm font-bold text-gray-700 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none bg-white shadow-sm">
                                    <option value="INR" {{ old('currency') == 'INR' ? 'selected' : '' }}>₹ INR (Rupee)</option>
                            ...
                            <div>
                                ...
                                <input type="text" name="invoice_prefix" value="{{ old('invoice_prefix') }}" placeholder="e.g. BOM-INV-"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm uppercase font-mono focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                            </div>
                            <div>
                                <label class="block text-[11px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Quotation Prefix</label>
                                <input type="text" name="quotation_prefix" value="{{ old('quotation_prefix') }}" placeholder="e.g. BOM-QTN-"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm uppercase font-mono focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                            </div>
                            <div class="hidden lg:block"></div> {{-- Empty space for grid alignment --}}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                            <div class="md:col-span-2 lg:col-span-1">
                                ...
                                <input type="text" name="bank_name" value="{{ old('bank_name') }}" placeholder="e.g. HDFC Bank"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                            </div>
                            <div class="md:col-span-1">
                                <label class="block text-[11px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Account Name</label>
                                <input type="text" name="account_name" value="{{ old('account_name') }}" placeholder="e.g. Acme Corp Ltd"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                            </div>
                            <div class="md:col-span-1">
                                <label class="block text-[11px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Account Number</label>
                                <input type="text" name="account_number" value="{{ old('account_number') }}" placeholder="e.g. 502000123456"
                            ...
                            <div class="md:col-span-1">
                                ...
                                <input type="text" name="ifsc_code" value="{{ old('ifsc_code') }}" placeholder="e.g. HDFC0001234"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm uppercase font-mono focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                            </div>
                            <div class="md:col-span-1">
                                <label class="block text-[11px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Branch Name</label>
                                <input type="text" name="branch_name" value="{{ old('branch_name') }}" placeholder="e.g. CG Road Branch"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                            </div>
                        </div>
                    </div>
