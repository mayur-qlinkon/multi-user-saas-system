                ...
                <div class="card-box">
                    ...
                    <div>
                        ...
                        <textarea name="content" rows="18" 
                                  ...
                                  placeholder="<h2>Write your content here...</h2>">{{ old('content', $page->content ?? '') }}</textarea>
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="is_published" value="1" class="sr-only peer" {{ old('is_published', $page->is_published ?? false) ? 'checked' : '' }}>
                        ...
                        <div class="input-group">
                            ...
                            <select name="slug" class="input-group-field font-mono">
                                ...
                                @foreach ($requiredSlugs as $slug => $label)
                                    <option value="{{ $slug }}"
                                        @selected(old('slug', $page->slug ?? '') === $slug)>
                                        {{ $slug }}
                                    </option>
                                @endforeach
                            </select>
