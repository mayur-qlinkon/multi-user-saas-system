    ...
    <div class="space-y-6 pb-10" x-data="categoryCrud()">
     ...
     class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col hover:shadow-lg transition-all duration-300 group relative">
                    ...
                    <div class="flex items-center gap-4 mb-6 pr-16">
                        <div class="w-12 h-12 rounded-xl border border-gray-100 overflow-hidden flex-shrink-0 shadow-sm flex items-center justify-center" style="background-color: {{ $category->color ?? '#f8fafc' }}">
                    ...
                    <div class="space-y-3 mb-6 flex-1">
                        ...
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span class="text-gray-700 font-bold uppercase text-[11px] bg-gray-50 px-2 py-0.5 rounded border border-gray-100">{{ str_replace('_', ' ', $category->gst_type) }}</span>
                        </div>
                        <div class="flex items-center justify-between text-sm">
