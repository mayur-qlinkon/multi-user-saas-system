                    ...
                    <div class="space-y-3 text-[13px] font-medium text-gray-500">
                        ...
                        <div class="flex items-start justify-between px-1">
                            ...
                            <div class="flex flex-col items-end gap-1">
                                ...
                                {{-- The auto-calculated amount displays right below the input --}}
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('posEngine', (companyState, storeId, clientsList, paymentMethodsList) => ({
                ...
                async saveQuickClient() {
                    // 🌟 Only Name and Phone are required now
                    if (!this.newClient.name || this.newClient.phone.length !== 10) {
                        BizAlert.toast('Please provide a name and a valid 10-digit phone number.', 'error');
                        return;
                    }
