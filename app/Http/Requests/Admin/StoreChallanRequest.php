...
class StoreChallanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'to_warehouse_id' => 'required_if:challan_type,branch_transfer|nullable|exists:warehouses,id',
            ...
            // Allow initial creation as draft or directly dispatched
            'status' => ['nullable', 'string', Rule::in([Challan::STATUS_DRAFT, Challan::STATUS_DISPATCHED])],
            ...
            // ════════════════════════════════════════════════════
            //  LINE ITEMS (Based strictly on challan_items schema)
            // ════════════════════════════════════════════════════
            ...
            // Name is the only strictly required string to support ad-hoc/custom items
    ...
    public function messages(): array
    {
        return [
            ...
            'items.required' => 'You must add at least one item to the challan.',
