...
class PlatformSeederController extends Controller
{
    ...
    private array $seeders = [
        'units' => [
            ...
            'class'            => \Database\Seeders\Inventory\UnitsSeeder::class,
        ...
        'categories' => [
            ...
            'class'            => \Database\Seeders\Inventory\CategoriesSeeder::class,
            'requires_company' => true,
            'icon'             => 'folder',
            'color'            => 'orange',
        ],
        ...
        'attributes' => [
            ...
            'class'            => \Database\Seeders\Inventory\AttributesSeeder::class,
            'requires_company' => true,
            'icon'             => 'archive',
            'color'            => 'emerald',
        ],
        ...
        'products' => [
            ...
            'class'            => \Database\Seeders\Inventory\ProductsSeeder::class,
            'requires_company' => true,
            'icon'             => 'archive',
            'color'            => 'purple',
        ],
        'clients' => [
            ...
            'class'            => \Database\Seeders\ClientsSeeder::class,
            'requires_company' => true,
            'icon'             => 'briefcase',
            'color'            => 'purple',
        ],
        'suppliers' => [
            ...
            'class'            => \Database\Seeders\SuppliersSeeder::class,
            'requires_company' => true,
            'icon'             => 'briefcase',
            'color'            => 'purple',
        ],
        ...
        'states' => [
            ...
            'class'            => \Database\Seeders\StateSeeder::class,
        ...
        'saas_modules' => [
            ...
            'class'            => \Database\Seeders\ModuleSeeder::class,
            'requires_company' => false, // 🌟 False because this is global data
            'icon'             => 'boxes',
            'color'            => 'emerald',
        ],
        ...
        'hrm_departments' => [
            ...
            'class'            => \Database\Seeders\HRM\DepartmentSeeder::class,
            'requires_company' => true,
            'icon'             => 'briefcase',
            'color'            => 'blue',
        ],
        'hrm_designations' => [
            ...
            'class'            => \Database\Seeders\HRM\DesignationSeeder::class,
            'requires_company' => true,
            'icon'             => 'award',
            'color'            => 'purple',
        ],
        'hrm_leave_types' => [
            ...
            'class'            => \Database\Seeders\HRM\LeaveTypeSeeder::class,
            'requires_company' => true,
            'icon'             => 'calendar-off',
            'color'            => 'blue',
        ],
