...
<?php $__env->startSection('header-title'); ?>
    <div>
        <h1 class="text-sm font-bold text-gray-500 uppercase tracking-widest">CRM Leads</h1>        
    </div>
...
<div class="pb-10" x-data="leadsPage()" x-init="init()">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-6 gap-3 mb-5">
        ...
        <a href="<?php echo e(route('admin.crm.leads.index')); ?>"
            ...
            <p class="text-2xl font-black text-gray-900"><?php echo e(number_format($stats['total'])); ?></p>
        </a>

        <a href="<?php echo e(route('admin.crm.leads.index', ['converted' => 0])); ?>"
            class="stat-card block">
            <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Active</p>
            <p class="text-2xl font-black text-gray-900">
                <?php echo e(number_format($stats['total'] - $stats['converted'])); ?>
        ...
        <a href="<?php echo e(route('admin.crm.leads.index', ['converted' => 1])); ?>"
            class="stat-card block">
        ...
        <div class="stat-card">
            ...
            <p class="text-lg font-black text-gray-900">
                ₹<?php echo e(number_format($stats['total_value'] / 1000, 1)); ?>k
            </p>
        </div>
    ...
    <div class="bg-white border border-gray-100 rounded-2xl px-4 py-3 mb-4">
        <form method="GET" action="<?php echo e(route('admin.crm.leads.index')); ?>" id="filter-form">
            ...
            <div class="grid grid-cols-1 sm:flex sm:items-center gap-3">
                ...
                <select name="pipeline_id" class="filter-input" onchange="this.form.submit()">
                    ...
                    <?php $__currentLoopData = $pipelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($pl->id); ?>" <?php echo e(($filters['pipeline_id'] ?? '') == $pl->id ? 'selected' : ''); ?>>
                            <?php echo e($pl->name); ?>
                ...
                <select name="stage_id" class="filter-input" onchange="this.form.submit()">
                    ...
                    <?php $__currentLoopData = $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($stage->id); ?>" <?php echo e(($filters['stage_id'] ?? '') == $stage->id ? 'selected' : ''); ?>>
                ...
                <select name="priority" class="filter-input" onchange="this.form.submit()">
                    ...
                    <option value="hot"    <?php echo e(($filters['priority'] ?? '') === 'hot'    ? 'selected' : ''); ?>>🔥 Hot</option>
                ...
                <select name="source_id" class="filter-input" onchange="this.form.submit()">
                    ...
                    <?php $__currentLoopData = $sources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $src): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($src->id); ?>" <?php echo e(($filters['source_id'] ?? '') == $src->id ? 'selected' : ''); ?>>
                            <?php echo e($src->name); ?>
                ...
                <div class="grid grid-cols-2 sm:flex items-center gap-2">
                    <a href="<?php echo e(route('admin.crm.leads.index', array_merge($filters, ['mine' => 1]))); ?>"
                        class="text-[11px] font-bold px-3 py-1.5 rounded-lg border transition-colors
                        <?php echo e(!empty($filters['mine']) ? 'border-brand text-white' : 'border-gray-200 text-gray-500 hover:bg-gray-50'); ?>"
                        style="<?php echo e(!empty($filters['mine']) ? 'background: var(--brand-600); border-color: var(--brand-600)' : ''); ?>">
                        My Leads
                    </a>
                    <a href="<?php echo e(route('admin.crm.leads.index', array_merge($filters, ['overdue' => 1]))); ?>"
                        class="text-[11px] font-bold px-3 py-1.5 rounded-lg border transition-colors
                        <?php echo e(!empty($filters['overdue']) ? 'bg-orange-500 border-orange-500 text-white' : 'border-gray-200 text-gray-500 hover:bg-gray-50'); ?>">
                        Overdue
                    </a>
                    <a href="<?php echo e(route('admin.crm.leads.index', array_merge($filters, ['unassigned' => 1]))); ?>"
                        class="text-[11px] font-bold px-3 py-1.5 rounded-lg border transition-colors
                        <?php echo e(!empty($filters['unassigned']) ? 'bg-gray-700 border-gray-700 text-white' : 'border-gray-200 text-gray-500 hover:bg-gray-50'); ?>">
                        Unassigned
                    </a>
                ...
                <?php if(has_permission('crm_leads.create')): ?>
                ...
                <?php if(has_permission('crm_leads.import')): ?>
                <a href="<?php echo e(route('admin.crm.leads.import')); ?>"
                ...
                <?php if(has_permission('crm_leads.export')): ?>
                <a href="<?php echo e(route('admin.crm.leads.export', request()->query())); ?>" target="_blank"
                    class="w-full sm:w-auto inline-flex items-center justify-center gap-1.5 text-[12px] font-bold px-4 py-2.5 rounded-lg border border-gray-200 text-gray-600 hover:bg-gray-50 transition-colors">
    ...
    <div class="bg-white border border-gray-100 rounded-2xl overflow-hidden">
        ...
        <div class="flex items-center gap-2 overflow-x-auto no-scrollbar pb-1 -mx-2 px-2">
                ...
                <?php $__currentLoopData = ['created_at' => 'Newest', 'score' => 'Score', 'lead_value' => 'Value', 'next_followup_at' => 'Follow-up']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('admin.crm.leads.index', array_merge($filters, ['sort' => $field, 'dir' => ($filters['sort'] ?? '') === $field && ($filters['dir'] ?? '') === 'asc' ? 'desc' : 'asc']))); ?>"
                        class="text-[11px] font-bold px-2.5 py-1 rounded-lg transition-colors
                        <?php echo e(($filters['sort'] ?? 'created_at') === $field ? 'text-white' : 'text-gray-400 hover:bg-gray-100'); ?>"
                        style="<?php echo e(($filters['sort'] ?? 'created_at') === $field ? 'background: var(--brand-600)' : ''); ?>">
                        <?php echo e($label); ?>

                        <?php if(($filters['sort'] ?? 'created_at') === $field): ?>
                            <?php echo e(($filters['dir'] ?? 'desc') === 'desc' ? '↓' : '↑'); ?>
                        ...
                        <?php $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="table-row">
                                ...
                                <td class="px-5 py-3 text-[12px] font-bold text-gray-400">
                                    <?php echo e($leads->firstItem() + $loop->index); ?>
                                ...
                                <td class="px-5 py-3">
                                    <div class="flex items-center gap-3">
                                        <div class="lead-avatar" style="background: <?php echo e($avatarBg); ?>">
                                            <?php echo e($initials); ?>
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-[11px] text-gray-400 font-medium truncate">
                                                <?php echo e($lead->phone ?? $lead->email ?? '—'); ?>
                                ...
                                <td class="px-3 py-3">
                                    ...
                                    <div x-data="{ currentStageColor: '<?php echo e($lead->stage->color ?? '#9ca3af'); ?>' }" 
                                        class="relative inline-block group w-[130px]" 
                                        title="<?php echo e($lead->stage->name ?? ''); ?>">
                                        
                                        <select <?php if(has_permission('crm_leads.change_stage')): ?>
                                            @change="updateLeadStage($event, <?php echo e($lead->id); ?>, '<?php echo e($lead->crm_stage_id); ?>')"
                                            <?php endif; ?>
                                        ...
                                        >
                                            ...
                                            <?php $__currentLoopData = $relevantStages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($st->id); ?>" 
                                                    <?php echo e($lead->crm_stage_id == $st->id ? 'selected' : ''); ?>

                                                    data-color="<?php echo e($st->color); ?>"
                                ...
                                <td class="px-3 py-3">
                                    <span class="priority-badge"
                                        style="background: <?php echo e($pColor['bg']); ?>; color: <?php echo e($pColor['text']); ?>">
                                        <span class="w-1.5 h-1.5 rounded-full"
                                            style="background: <?php echo e($pColor['dot']); ?>"></span>
                                    ...
                                    <div class="flex flex-col gap-1">
                                        <span class="text-[12px] font-black text-gray-700">
                                            ...
                                            <span class="text-[10px] font-semibold text-gray-400">
                                                <?php echo e($lead->score_label); ?>

                                            </span>
                                        </span>
                                        <div class="score-bar">
                                            <div class="score-fill"
                                                style="width: <?php echo e(min(100, $lead->score)); ?>%;
                                                background: <?php echo e($lead->score >= 50 ? '#ef4444' : ($lead->score >= 20 ? '#f59e0b' : '#9ca3af')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-3 py-3">
                                    <?php $assignee = $lead->assignees->first(); ?>
                                    <?php if($assignee): ?>
                                ...
                                <td class="px-3 py-3">
                                    <?php if($lead->next_followup_at): ?>
                                        <span class="text-[11px] font-semibold
                                            <?php echo e($lead->is_overdue ? 'text-red-600' : 'text-gray-600'); ?>">
                                            <?php echo e($lead->is_overdue ? '⚠ ' : ''); ?><?php echo e($lead->next_followup_at->format('d M')); ?>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-1 justify-end">
                                        ...
                                        <?php if(has_permission('crm_leads.update')): ?>
                                        ...
                                        <?php if(has_permission('crm_leads.delete')): ?>
                                        <button
                                            @click="deleteLead(<?php echo e($lead->id); ?>, '<?php echo e(addslashes($lead->name)); ?>')"
            ...
            <?php if($leads->hasPages()): ?>
                <div class="px-5 py-4 border-t border-gray-50 flex items-center justify-between flex-wrap gap-3">
                    <p class="text-[12px] text-gray-400 font-medium">
                        Showing <?php echo e($leads->firstItem()); ?>–<?php echo e($leads->lastItem()); ?> of <?php echo e($leads->total()); ?>
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($leads->previousPageUrl()); ?>"
                                class="px-3 py-1.5 rounded-lg text-[12px] font-bold text-gray-600 hover:bg-gray-100 transition-colors">← Prev</a>
                        <?php endif; ?>

                        
                        <?php $__currentLoopData = $leads->getUrlRange(max(1, $leads->currentPage()-2), min($leads->lastPage(), $leads->currentPage()+2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e($url); ?>"
                                class="w-8 h-8 flex items-center justify-center rounded-lg text-[12px] font-bold transition-colors
                                <?php echo e($page == $leads->currentPage() ? 'text-white' : 'text-gray-600 hover:bg-gray-100'); ?>"
                                style="<?php echo e($page == $leads->currentPage() ? 'background: var(--brand-600)' : ''); ?>">
                                <?php echo e($page); ?>
                        ...
                        <?php if($leads->hasMorePages()): ?>
                            <a href="<?php echo e($leads->nextPageUrl()); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/crm/leads/index.blade.php ENDPATH**/ ?>