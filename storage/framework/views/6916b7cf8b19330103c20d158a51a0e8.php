            ...
            <table class="w-full">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $shifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="table-row" x-show="matchesSearch('<?php echo e(strtolower($shift->name)); ?>')">
                            <td class="px-5 py-3 text-[12px] font-bold text-gray-400"><?php echo e($shifts->firstItem() + $loop->index); ?></td>
                            <td class="px-5 py-3">
                            ...
                            <td class="px-3 py-3 text-center text-[12px] text-gray-600"><?php echo e($shift->break_duration_minutes); ?> min</td>
                            <td class="px-3 py-3 text-center"><span class="text-[12px] font-bold text-gray-700"><?php echo e($shift->employees_count); ?></span></td>
