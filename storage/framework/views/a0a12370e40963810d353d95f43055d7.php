            ...
            <div class="info-card">
                ...
                <div class="card-body">
                    ...
                    <div class="border-t border-gray-100 pt-4" x-data="attachmentUpload()">
                        ...
                        <div
                            class="flex flex-col gap-3 rounded-xl border border-dashed border-gray-300 bg-gray-50 p-4 sm:flex-row sm:items-center sm:justify-between"
                            :class="selectedFile ? 'border-teal-400 bg-teal-50/40' : ''"
                        >
                            <div class="flex items-center gap-3 min-w-0">
                                <div class="flex h-11 w-11 items-center justify-center rounded-full bg-white border border-gray-200 shadow-sm">
