            ...
            <div class="flex flex-wrap items-center gap-3 w-full">
                ...
                <select name="assigned_to" class="filter-input" onchange="this.form.submit()">
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($user->id); ?>" <?php echo e(($filters['assigned_to'] ?? '') == $user->id ? 'selected' : ''); ?>>
...
function leadsPage() {
    return {
        selectedLeads: [],
        currentViewLeadIds: <?php echo json_encode($leads->pluck('id'), 15, 512) ?>,
        ...
        async bulkDeleteLeads() {
            ...
            try {
                const res = await fetch(`<?php echo e(route('admin.crm.leads.bulk_destroy')); ?>`, {
                    method: 'POST',
                    headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/crm/leads/index.blade.php ENDPATH**/ ?>