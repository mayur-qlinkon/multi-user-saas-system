            ...
            <div class="flex items-center gap-4 shrink-0 text-gray-600">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if($user->hasRole('customer')): ?>
                        <?php echo e(route('storefront.portal.dashboard', ['slug' => $companySlug])); ?>

                    <?php elseif($user->hasRole('owner')): ?>
                        <?php echo e(route('admin.dashboard')); ?>

                    <?php elseif($user->hasRole('employee')): ?>
                        <?php echo e(route('admin.hrm.employee.dashboard')); ?>
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <?php echo e(route('storefront.login',['slug' => $companySlug])); ?>
...
<?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/layouts/storefront.blade.php ENDPATH**/ ?>