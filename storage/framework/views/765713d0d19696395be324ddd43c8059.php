<?php $__env->startSection('title', 'Create Storefront Section'); ?>
    ...
    <div class="pb-10" x-data="sectionForm()">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div class="flex items-center gap-2 text-sm text-gray-400 font-medium">
                <a href="<?php echo e(route('admin.storefront-sections.index')); ?>" class="hover:text-brand-600 transition-colors">
                    Storefront Sections
                </a>
        ...
        <form id="section-form" method="POST" action="<?php echo e(route('admin.storefront-sections.store')); ?>"
                    ...
                    <div class="form-section">
                        ...
                        <div class="type-grid">
                            <?php $__currentLoopData = $formData['types']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <label class="type-pill-label <?php echo e(old('type', 'category') === $value ? 'selected' : ''); ?>"
                                    @click="selectType('<?php echo e($value); ?>')">
                                    <input type="radio" name="type" value="<?php echo e($value); ?>"
                                        <?php echo e(old('type', 'category') === $value ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-4" x-show="sectionType === 'custom_html'" x-cloak>
                            ...
                            <textarea name="custom_html" class="field-input" rows="5" placeholder="<div>Your custom HTML here...</div>"><?php echo e(old('custom_html')); ?></textarea>
                    ...
                    <div class="form-section">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                            ...
                            <div>
                                ...
                                <select name="layout" class="field-input" x-model="layout">
                                    <?php $__currentLoopData = $formData['layouts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>"
                                            <?php echo e(old('layout', 'grid') === $value ? 'selected' : ''); ?>>
                                            <?php echo e($label); ?>
                            ...
                            <div>
                                ...
                                <input type="number" name="products_limit" value="<?php echo e(old('products_limit', 8)); ?>"
                                    min="1" max="48"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div x-show="layout === 'grid'" class="mb-5">
                            ...
                            <div class="flex items-center gap-2 flex-wrap">
                                <?php $__currentLoopData = [2, 3, 4, 5, 6]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="col-option <?php echo e(old('columns', 4) == $col ? 'active' : ''); ?>"
                                        @click="selectColumns(<?php echo e($col); ?>)">
                                        <input type="radio" name="columns" value="<?php echo e($col); ?>"
                                            <?php echo e(old('columns', 4) == $col ? 'checked' : ''); ?>>
                                        <div class="col-dots">
                                            <?php for($i = 0; $i < $col; $i++): ?>
                        ...
                        <div>
                            <label class="field-label">Custom "View All" URL <span
                                    class="text-gray-400 normal-case font-normal">(optional)</span></label>
                            <input type="url" name="view_all_url" value="<?php echo e(old('view_all_url')); ?>"
                        ...
                        <div x-show="open" x-cloak x-transition class="space-y-4 mt-2">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="color" name="bg_color" value="<?php echo e(old('bg_color', '#ffffff')); ?>"
                                ...
                                <div>
                                    ...
                                    <input type="color" name="heading_color"
                                        value="<?php echo e(old('heading_color', '#212538')); ?>"
                                        class="w-full h-10 rounded-xl border border-gray-200 cursor-pointer">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="toggle-row">
                                ...
                                <label class="toggle-switch">
                                    <input type="checkbox" name="show_section_title" value="1"
                                        <?php echo e(old('show_section_title', '1') === '1' ? 'checked' : ''); ?>>
                                    <div class="toggle-track"></div>
                                    <div class="toggle-thumb"></div>
                                </label>
                            </div>
                            ...
                            <div class="toggle-row">
                                ...
                                <label class="toggle-switch">
                                    <input type="checkbox" name="show_view_all" value="1"
                                        <?php echo e(old('show_view_all', '1') === '1' ? 'checked' : ''); ?>>
                                    <div class="toggle-track"></div>
                                    <div class="toggle-thumb"></div>
                                </label>
                            </div>
                            ...
                            <div class="toggle-row">
                                ...
                                <label class="toggle-switch">
                                    <input type="checkbox" name="show_on_desktop" value="1"
                                        <?php echo e(old('show_on_desktop', '1') === '1' ? 'checked' : ''); ?>>
                                    <div class="toggle-track"></div>
                                    <div class="toggle-thumb"></div>
                                </label>
                            </div>
                            <div class="toggle-row">
                                ...
                                <label class="toggle-switch">
                                    <input type="checkbox" name="show_on_mobile" value="1"
                                        <?php echo e(old('show_on_mobile', '1') === '1' ? 'checked' : ''); ?>>
                                    <div class="toggle-track"></div>
                                    <div class="toggle-thumb"></div>
                                </label>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-section">
                        ...
                        <input type="number" name="sort_order" value="<?php echo e(old('sort_order', '')); ?>" min="0"
...
<?php $__env->startPush('scripts'); ?>
    <script>
        function sectionForm() {
            return {
                isSubmitting: false,
                sectionType: '<?php echo e(old('type', 'category')); ?>',
                layout: '<?php echo e(old('layout', 'grid')); ?>',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/storefront-sections/create.blade.php ENDPATH**/ ?>