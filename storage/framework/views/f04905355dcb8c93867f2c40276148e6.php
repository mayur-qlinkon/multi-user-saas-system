            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div>
                        ...
                        <input type="text" name="transport_name" value="<?php echo e(old('transport_name')); ?>" placeholder="e.g. BlueDart"
                    ...
                    <div>
                        ...
                        <input type="text" name="vehicle_number" value="<?php echo e(old('vehicle_number')); ?>" placeholder="GJ01XX1234"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/challans/create.blade.php ENDPATH**/ ?>