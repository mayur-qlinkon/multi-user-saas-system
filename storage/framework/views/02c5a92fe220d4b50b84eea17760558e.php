<?php $__env->startSection('title', 'Clients Management - Qlinkon BIZNESS'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="pb-10" x-data="clientManager(<?php echo \Illuminate\Support\Js::from($clients->items())->toHtml() ?>)">
            ...
            <form method="GET" action="<?php echo e(route('admin.clients.index')); ?>"
                ...
                <div class="flex flex-col sm:flex-row sm:flex-wrap gap-2 w-full xl:flex-1 xl:max-w-3xl">
                    ...
                    <select name="registration_type"
                        ...
                        <option value="registered" <?php if(($registrationType ?? '') === 'registered'): echo 'selected'; endif; ?>>Regular</option>
                        <option value="composition" <?php if(($registrationType ?? '') === 'composition'): echo 'selected'; endif; ?>>Composition</option>
                        <option value="unregistered" <?php if(($registrationType ?? '') === 'unregistered'): echo 'selected'; endif; ?>>Unregistered</option>
                        <option value="sez" <?php if(($registrationType ?? '') === 'sez'): echo 'selected'; endif; ?>>SEZ</option>
                        <option value="overseas" <?php if(($registrationType ?? '') === 'overseas'): echo 'selected'; endif; ?>>Overseas</option>
                    </select>
                    ...
                    <div class="flex gap-2">
                        ...
                        <?php if(!empty($search) || !empty($status) || !empty($registrationType)): ?>
                ...
                <div class="flex flex-row flex-wrap items-center gap-2 w-full xl:w-auto justify-start xl:justify-end mt-2 xl:mt-0">
                    ...
                    <?php if(has_permission('clients.export')): ?>
                    ...
                    <?php if(has_module('bulk_import') && has_permission('clients.create')): ?>
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <div class="text-sm font-bold text-gray-800"><?php echo e($client->name); ?></div>
                                            <div class="text-[12px] text-gray-400 mt-0.5">
                                                <?php echo e($client->email ?? 'No email added'); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div
                                        ...
                                        <?php if(has_permission('clients.update')): ?>
                                        <button type="button" @click="openEdit(<?php echo e($client->id); ?>)"
                                        ...
                                        <button type="button"
                                            @click="openDelete(<?php echo e($client->id); ?>, '<?php echo e(addslashes($client->name)); ?>')"
                    ...
                    <div class="p-4 hover:bg-gray-50/50 transition-colors flex flex-col gap-3">
                        ...
                        <div class="flex justify-between items-start gap-2">
                            <div class="flex items-center gap-3 min-w-0">
                                ...
                                <div class="min-w-0">
                                    <p class="font-bold text-[14px] text-gray-900 truncate"><?php echo e($client->name); ?></p>
                                    <p class="text-[11px] text-gray-500 mt-0.5 truncate"><?php echo e($client->email ?? 'No email added'); ?></p>
                                </div>
                            </div>
                            <div class="shrink-0">
                                <?php if($client->is_active): ?>
                        ...
                        <div class="flex items-center justify-end gap-2 pt-1 border-t border-gray-50 mt-1">
                            <?php if(has_permission('clients.update')): ?>
                                <button type="button" @click="openEdit(<?php echo e($client->id); ?>)" class="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 hover:text-blue-700 flex items-center justify-center transition-colors" title="Edit Client">
                                    <i data-lucide="pencil" class="w-4 h-4"></i>
                                </button>
                            <?php endif; ?>

                            <?php if(has_permission('clients.delete')): ?>
                                <button type="button" @click="openDelete(<?php echo e($client->id); ?>, '<?php echo e(addslashes($client->name)); ?>')" class="w-8 h-8 rounded-lg bg-red-50 text-red-500 hover:bg-red-100 hover:text-red-600 flex items-center justify-center transition-colors" title="Delete Client">
                                    <i data-lucide="trash-2" class="w-4 h-4"></i>
                                </button>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/clients.blade.php ENDPATH**/ ?>