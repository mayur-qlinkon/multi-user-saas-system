...
<head>
    <meta charset="utf-8">
    <title>Return #<?php echo e($challanReturn->return_number); ?></title>
    <style>
        body {
    ...
    <table style="margin-bottom: 30px;">
        <tr>
            <td style="width: 50%;">
                ...
                <div class="font-bold text-gray mt-4" style="font-size: 14px;"># <?php echo e($challanReturn->return_number); ?></div>
                <div class="badge">
                    CONDITION: <?php echo e($challanReturn->condition_label); ?>
            ...
            <td style="width: 50%;" class="text-right">
                ...
                <div class="text-gray" style="line-height: 1.4; margin-top: 6px;">
                    <?php if(isset($company->gst_number) || isset($company->gstin)): ?>
                        GSTIN: <strong style="color: #333;"><?php echo e($company->gst_number ?? $company->gstin); ?></strong><br>
                    <?php endif; ?>
    ...
    <table class="border-top border-bottom" style="margin-bottom: 30px; padding: 15px 0;">
        <tr>
            <td style="width: 50%;">
                ...
                <div style="font-size: 14px; font-weight: bold; margin-bottom: 3px;"><?php echo e($partyName); ?></div>
                <div class="text-gray" style="line-height: 1.4;">
                    ...
                    <?php if($partyPhone !== 'N/A'): ?>
                        Phone: <?php echo e($partyPhone); ?><br>
                    <?php endif; ?>
                    <?php if($partyGSTIN): ?>
                        GSTIN: <strong style="color: #333;"><?php echo e($partyGSTIN); ?></strong>
                    <?php endif; ?>
                </div>
            </td>
            <td style="width: 50%; line-height: 1.8;">
                <table>
                    <tr>
                        ...
                        <td class="font-bold text-right"><?php echo e($challanReturn->return_date->format('d M Y')); ?></td>
                    </tr>
                    <tr>
                        <td class="text-gray font-bold text-right">Original Challan:</td>
                        <td class="font-bold text-right"><?php echo e($challan->challan_number); ?></td>
                    </tr>
                    <?php if($challanReturn->vehicle_number): ?>
                        <tr>
                            <td class="text-gray font-bold text-right">Return Vehicle No:</td>
                            <td class="font-bold text-right uppercase"><?php echo e($challanReturn->vehicle_number); ?></td>
                        </tr>
                    <?php endif; ?>
                    <?php if($challanReturn->received_by): ?>
                        <tr>
                            <td class="text-gray font-bold text-right">Received By:</td>
                            <td class="font-bold text-right"><?php echo e($challanReturn->received_by); ?></td>
                        </tr>
                    <?php endif; ?>
                </table>
            </td>
    ...
    <table class="items-table" style="margin-bottom: 30px;">
        ...
        <tbody>
            <?php $__currentLoopData = $challanReturn->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td>
                        <div class="font-bold"><?php echo e($item->challanItem->product_name ?? 'Unknown Product'); ?></div>
                        <div style="font-size: 10px; color: #777;">SKU: <?php echo e($item->challanItem->sku_code ?? 'N/A'); ?></div>
                    </td>
                    <td class="text-center text-gray"><?php echo e((float) ($item->challanItem->qty_sent ?? 0)); ?></td>
                    <td class="text-center font-bold"><?php echo e((float) $item->qty_returned); ?></td>
                    <td class="text-center font-bold" style="<?php echo e($item->qty_damaged > 0 ? 'color: #333;' : 'color: #999;'); ?>">
            ...
            <td style="width: 50%; padding-right: 20px;">
                <?php if($challanReturn->notes): ?>
                    <div style="margin-bottom: 15px;">
                        ...
                        <div class="text-gray" style="line-height: 1.4;"><?php echo e($challanReturn->notes); ?></div>
                    </div>
                <?php endif; ?>
            </td>
            ...
            <td style="width: 50%;">
                <table class="totals-table">
                    <tr>
                        ...
                        <td class="font-bold text-right"><?php echo e((float) $challanReturn->total_qty_returned); ?></td>
                    </tr>
                    <tr>
                        <td class="font-bold text-right border-bottom" style="padding-bottom: 10px; color: #333;">Total Damaged</td>
                        <td class="font-bold text-right border-bottom" style="padding-bottom: 10px; color: #333;"><?php echo e((float) $challanReturn->total_qty_damaged); ?></td>
                    </tr>
                    <tr>
                        <td class="font-bold text-right" style="font-size: 14px; padding: 12px 10px; color: #333;">Clean Stock Recovered</td>
                        <td class="font-bold text-right" style="font-size: 14px; padding: 12px 10px; color: #333;"><?php echo e((float) $challanReturn->total_qty_clean); ?></td>
                    </tr>
                </table>
            </td>
        </tr>
...
</html><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/challan-returns/pdf.blade.php ENDPATH**/ ?>