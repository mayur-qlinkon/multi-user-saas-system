...
<?php $__env->startSection('header-title'); ?>
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-sm font-bold text-gray-500 uppercase tracking-widest"><?php echo e(isset($page) ? 'Edit Page' : 'Create Page'); ?></h1>
            <p class="text-xs text-gray-400 font-medium mt-1"><?php echo e(isset($page) ? $page->title : 'Add new content to your storefront'); ?></p>
        </div>
    </div>
...
<div class="pb-10 w-full max-w-[1600px] mx-auto">
    ...
    <form method="POST" action="<?php echo e(isset($page) ? route('admin.pages.update', $page->id) : route('admin.pages.store')); ?>" class="w-full">
        <?php echo csrf_field(); ?>
            ...
            <div class="flex-1 min-w-0 space-y-6">
                ...
                <div class="card-box">
                    <div class="mb-5">
                        ...
                        <input type="text" name="title" value="<?php echo e(old('title', $page->title ?? '')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="content" rows="18" 
                                  ...
                                  placeholder="<h2>Write your content here...</h2>"><?php echo e(old('content', $page->content ?? '')); ?></textarea>
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="is_published" value="1" class="sr-only peer" <?php echo e(old('is_published', $page->is_published ?? false) ? 'checked' : ''); ?>>
                    ...
                    <div class="mb-5">
                        ...
                        <select name="type" class="form-input bg-gray-50 cursor-pointer" required>
                            <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(old('type', $page->type ?? '') == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card-box">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="seo_title" value="<?php echo e(old('seo_title', $page->seo_title ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="seo_description" rows="4" class="form-input text-[13px]" 
                                  placeholder="A brief summary of this page..."><?php echo e(old('seo_description', $page->seo_description ?? '')); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/storefront-sections/pages/edit.blade.php ENDPATH**/ ?>