<?php $__env->startSection('title', 'Order Inquiries'); ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-3 mb-6">
        ...
        <div class="stat-card">
            ...
            <div>
                ...
                <p class="text-xl font-black text-gray-900"><?php echo e(number_format($stats['total'])); ?></p>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div>
                ...
                <p class="text-xl font-black text-gray-900"><?php echo e(number_format($stats['inquiries'])); ?></p>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div>
                ...
                <p class="text-xl font-black text-gray-900"><?php echo e(number_format($stats['confirmed'])); ?></p>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div>
                ...
                <p class="text-xl font-black text-gray-900"><?php echo e(number_format($stats['shipped'])); ?></p>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div>
                ...
                <p class="text-xl font-black text-gray-900">₹<?php echo e(number_format($stats['revenue'], 0)); ?></p>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div>
                ...
                <p class="text-xl font-black text-gray-900"><?php echo e(number_format($stats['today'])); ?></p>
            </div>
        </div>
        ...
        <div class="px-5 py-4 border-b border-gray-100 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
                <h2 class="text-sm font-bold text-gray-700">
                    All Orders
                    <span class="text-gray-400 font-medium ml-1">(<?php echo e($orders->total()); ?>)</span>
                </h2>
            </div>
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 w-full xl:w-auto flex-wrap justify-end">
                ...
                <form method="GET" action="<?php echo e(route('admin.orders.index')); ?>" class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 w-full sm:w-auto flex-wrap">
                    ...
                    <select name="status" class="filter-input w-full sm:w-auto" onchange="this.form.submit()">
                        ...
                        <?php $__currentLoopData = $statusColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if(request()->hasAny(['q', 'status', 'from', 'to', 'payment_status', 'source'])): ?>
            ...
            <form method="GET" action="<?php echo e(route('admin.orders.index')); ?>"
                ...
                <div>
                    ...
                    <select name="payment_status" class="filter-input">
                        ...
                        <?php $__currentLoopData = array_keys(\App\Models\Order::PAYMENT_STATUS_COLORS); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div>
                    ...
                    <select name="source" class="filter-input">
                        ...
                        <option value="storefront" <?php echo e(request('source') === 'storefront' ? 'selected' : ''); ?>>Storefront</option>
                        ...
                        <option value="pos"        <?php echo e(request('source') === 'pos'        ? 'selected' : ''); ?>>POS</option>
                    </select>
                </div>

                <div>
                    <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">From Date</label>
                    <input type="date" name="from" value="<?php echo e(request('from')); ?>" class="filter-input">
                </div>

                <div>
                    <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">To Date</label>
                    <input type="date" name="to" value="<?php echo e(request('to')); ?>" class="filter-input">
                </div>
            ...
            <div class="order-row">
                ...
                <div class="min-w-0">
                    <div class="flex items-center gap-2 mb-0.5">
                        <span class="font-mono text-[13px] font-bold text-gray-900"><?php echo e($order->order_number); ?></span>
                        ...
                        <?php elseif($order->source === 'whatsapp'): ?>
                            <span class="text-[9px] font-bold px-1.5 py-0.5 rounded bg-green-50 text-green-600 uppercase tracking-wide">WA</span>
                        <?php endif; ?>
                    </div>
                    <p class="text-[13px] font-semibold text-gray-700 truncate"><?php echo e($order->customer_name); ?></p>
                    <p class="text-[11px] text-gray-400 font-medium font-mono"><?php echo e($order->customer_phone); ?></p>
                    <p class="text-[10px] text-gray-400 mt-0.5"><?php echo e($order->created_at->format('d M Y, h:i A')); ?></p>
                </div>

                
                <div class="min-w-0">
                    <p class="text-[12px] text-gray-600 font-medium mb-1">
                        <?php echo e($order->items_count); ?> item<?php echo e($order->items_count !== 1 ? 's' : ''); ?>

                        · <?php echo e($order->items_qty); ?> qty
                    </p>
                    <?php if($order->items->isNotEmpty()): ?>
                        <p class="text-[11px] text-gray-400 truncate">
                            <?php echo e($order->items->first()->product_name); ?>
                    ...
                    <?php if($order->delivery_city): ?>
                        <p class="text-[11px] text-gray-400 flex items-center gap-1 mt-0.5">
                            ...
                            <?php echo e($order->delivery_city); ?><?php echo e($order->delivery_state ? ', ' . $order->delivery_state : ''); ?>
                ...
                <?php if($order->order_type !== 'inquiry'): ?>
                    <div>
                        <p class="text-[14px] font-bold text-gray-900">₹<?php echo e(number_format($order->total_amount, 2)); ?></p>
                        <p class="text-[11px] text-gray-400 font-medium uppercase"><?php echo e($order->payment_method ?? 'COD'); ?></p>
                    </div>                
                <?php else: ?>
                    <div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <?php if($order->source === 'admin' && in_array($order->status, ['inquiry', 'confirmed', 'processing'])): ?>
                    ...
                    <?php if($order->customer_phone && get_setting('whatsapp')): ?>
                        <a href="https://wa.me/91<?php echo e(preg_replace('/[^0-9]/', '', $order->customer_phone)); ?>?text=<?php echo e(urlencode('Hi ' . $order->customer_name . ', your order #' . $order->order_number . ' has been received. We will confirm shortly.')); ?>"
                            target="_blank"
                ...
                <?php $__currentLoopData = $orders->getUrlRange(max(1, $orders->currentPage() - 2), min($orders->lastPage(), $orders->currentPage() + 2)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($page == $orders->currentPage()): ?>
                        <span class="w-8 h-8 flex items-center justify-center rounded-lg text-sm font-bold text-white"
                            style="background: var(--brand-600);"><?php echo e($page); ?></span>
                    <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>