        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
            <div class="stat-card">
                ...
                <div>
                    ...
                    <p class="text-xl font-black text-gray-900"><?php echo e(number_format($totalLogs)); ?></p>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div>
                    ...
                    <p class="text-xl font-black text-gray-900"><?php echo e($todayCount); ?></p>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div>
                    ...
                    <p class="text-xl font-black text-green-700"><?php echo e($createdCount); ?></p>
                </div>
            </div>
            <div class="stat-card">
                ...
                <div>
                    ...
                    <p class="text-xl font-black text-red-600"><?php echo e($deletedCount); ?></p>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="ml-auto flex items-center gap-2">
                <span class="text-xs text-gray-400 font-medium">
                    Showing <?php echo e($logs->firstItem()); ?>–<?php echo e($logs->lastItem()); ?> of <?php echo e(number_format($logs->total())); ?>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="log-row relative flex gap-4 px-5 py-4 border-b border-gray-50 hover:bg-gray-50/60 transition-colors"
                    style="animation-delay: <?php echo e($index * 20); ?>ms"
                    x-show="activeFilter === 'all' || activeFilter === '<?php echo e($event); ?>'">
                    ...
                    <div class="event-dot <?php echo e($dotClass); ?> mt-0.5">
                        <i data-lucide="<?php echo e($iconName); ?>" class="w-4 h-4"></i>
                    </div>
                        ...
                        <div class="flex flex-wrap items-start justify-between gap-2">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex flex-wrap items-center gap-2 mb-1.5">
                                    <span class="badge <?php echo e($badgeClass); ?>"><?php echo e($event); ?></span>
                                    <span class="module-chip">
                                        <i data-lucide="box" class="w-3 h-3"></i>
                                        <?php echo e($moduleName); ?>

                                        <?php if($log->subject_id): ?>
                                            <span class="text-gray-400">#<?php echo e($log->subject_id); ?></span>
                                        <?php endif; ?>
                                    </span>
                                </div>
                                ...
                                <?php if($hasChanges && count($attrs) > 0): ?>
                                    <div class="mt-2 flex flex-wrap gap-2">
                                        <?php $__currentLoopData = array_slice($attrs, 0, 3, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $newVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex items-center gap-1.5">
                                                <span class="diff-key"><?php echo e($key); ?></span>
                                                <?php if(isset($old[$key])): ?>
                                                    <span class="diff-old" title="<?php echo e($old[$key]); ?>">
                                                        <?php echo e(Str::limit($old[$key], 25)); ?>

                                                    </span>
                                                    <i data-lucide="arrow-right"
                                                        class="w-3 h-3 text-gray-300 flex-shrink-0"></i>
                                                <?php endif; ?>
                                                <span class="diff-new" title="<?php echo e($newVal); ?>">
                                                    <?php echo e(Str::limit($newVal, 25)); ?>

                                                </span>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(count($attrs) > 3): ?>
                                            <span class="text-[11px] text-gray-400 font-medium self-center">
                                                +<?php echo e(count($attrs) - 3); ?> more
                                            </span>
                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>
                            ...
                            <div class="flex flex-col items-end gap-2 flex-shrink-0">
                                ...
                                <?php if($hasChanges): ?>
                                    <button
                                        @click="viewChanges(<?php echo e(json_encode($log->properties)); ?>, '<?php echo e(addslashes($log->description)); ?>', '<?php echo e($event); ?>')"
                                        class="text-xs font-bold px-3 py-1.5 rounded-lg border transition-colors
                                        <?php echo e($event === 'deleted'
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/audit-logs/audit.blade.php ENDPATH**/ ?>