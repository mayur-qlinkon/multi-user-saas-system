...
<?php $__env->startSection('content'); ?>
    ...
    <div class="pb-20" x-data="invoiceForm(<?php echo \Illuminate\Support\Js::from($units ?? [])->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($companyState)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($invoice)->toHtml() ?>)">
                            ...
                            <div class="relative flex-1">
                                <select name="customer_id" x-model="formData.customer_id"
                                    ...
                                    <?php $__currentLoopData = $clients ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <option value="<?php echo e($client->id); ?>" data-state="<?php echo e($client->state_name_only); ?>"
                                            data-name="<?php echo e($client->name); ?>" data-gstin="<?php echo e($client->gst_number ?? ''); ?>">
                        ...
                        <select name="store_id" required x-model="formData.store_id" @change="updateStoreData($event)"
                            ...
                            <?php $__currentLoopData = $stores ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($store->id); ?>"
                                    data-state="<?php echo e($store->state->name ?? $companyState); ?>"><?php echo e($store->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/invoices/edit.blade.php ENDPATH**/ ?>