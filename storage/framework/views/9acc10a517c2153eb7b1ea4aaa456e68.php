                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors"
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-end gap-2.5">
                                        <?php if(has_permission('units.update')): ?>
                                        ...
                                        <?php if(has_permission('units.delete')): ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="p-4 hover:bg-gray-50/50 transition-colors flex flex-col gap-3"
                        ...
                        <div class="flex justify-between items-start gap-2">
                            <div class="min-w-0">
                                <p class="font-bold text-[14px] text-gray-900 truncate"><?php echo e($unit->name); ?></p>
                                <div class="flex items-center gap-2 mt-1">
                                    <span class="text-[11px] text-gray-500 font-medium">ID: #<?php echo e($unit->id); ?></span>
                        ...
                        <div class="flex items-center justify-end gap-2 pt-2 border-t border-gray-50 mt-1">
                            <?php if(has_permission('units.update')): ?>
                                <button @click="openEditModal(<?php echo e($unit->toJson()); ?>)" class="w-8 h-8 flex items-center justify-center rounded-lg border border-[#108c2a] text-[#108c2a] hover:bg-green-50 transition-colors" title="Edit">
                                    <i data-lucide="edit" class="w-4 h-4"></i>
                                </button>
                            <?php endif; ?>

                            <?php if(has_permission('units.delete')): ?>
                                <form action="<?php echo e(route('admin.units.destroy', $unit->id)); ?>" method="POST" @submit.prevent="deleteUnit($event.target)" class="inline-block m-0 p-0">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/products/units.blade.php ENDPATH**/ ?>