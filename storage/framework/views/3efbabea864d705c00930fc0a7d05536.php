...
<?php $__env->startSection('content'); ?>
    <div class="pb-10" x-data="purchaseForm(<?php echo \Illuminate\Support\Js::from($units ?? [])->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($batchEnabled ?? false)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($selectedSku ?? null)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($prefillQty ?? 1)->toHtml() ?>)">
        <div class="mb-6">
        ...
        <form action="<?php echo e(route('admin.purchases.store')); ?>" method="POST" @submit="BizAlert.loading('Saving Purchase...')">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div x-data="supplierSearch(<?php echo \Illuminate\Support\Js::from($suppliers ?? [])->toHtml() ?>, '<?php echo e(old('supplier_id')); ?>')"
                        ...
                        <select name="warehouse_id" required x-model="selectedWarehouse"
                            ...
                            <?php $__currentLoopData = $warehouses ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($warehouse->id); ?>"
                                    <?php echo e(old('warehouse_id') == $warehouse->id ? 'selected' : ''); ?>>
                        ...
                        <select name="store_id" required x-model="selectedStore" @change="autoSelectWarehouse()"
                            ...
                            <?php $__currentLoopData = $stores ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($store->id); ?>"
                                    <?php echo e(old('store_id', session('store_id')) == $store->id ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <input type="date" name="purchase_date" value="<?php echo e(old('purchase_date', date('Y-m-d'))); ?>"
                            required
                    ...
                    <div>
                        ...
                        <select name="status" required
                            ...
                            <option value="ordered" <?php echo e(old('status') == 'ordered' ? 'selected' : ''); ?>>Ordered / Sent
                            </option>
                            <option value="received" <?php echo e(old('status') == 'received' ? 'selected' : ''); ?>>Received (Updates
                                Stock)</option>
                        </select>
                    </div>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">Supplier Invoice
                            Date</label>
                        <input type="date" name="supplier_invoice_date" value="<?php echo e(old('supplier_invoice_date')); ?>"
                            class="w-full border border-gray-300 rounded px-3 py-2.5 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none">
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 flex flex-col gap-4">
                    <div>
                        ...
                        <textarea name="notes" rows="3"
                            class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none resize-none"><?php echo e(old('notes')); ?></textarea>
                    </div>
                    <div>
                        ...
                        <textarea name="terms_and_conditions" rows="3"
                            class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none resize-none"><?php echo e(old('terms_and_conditions')); ?></textarea>
                    </div>
                </div>
    ...
    <script>
        ...
        function purchaseForm(allUnits = [], batchEnabled = false, prefillSku = null, prefillQty = 1) {
            ...
            return {
                ...
                selectedStore: "<?php echo e(old('store_id', session('store_id'))); ?>",
                selectedWarehouse: "<?php echo e(old('warehouse_id')); ?>",
                ...
                global: {
                    discount_type: "<?php echo e(old('discount_type', 'percent')); ?>",
                    discount_value: parseFloat("<?php echo e(old('discount_value', 0)); ?>") || 0,
                    discount_amount: 0,
                    shipping: parseFloat("<?php echo e(old('shipping_cost', 0)); ?>") || 0,
                    other: parseFloat("<?php echo e(old('other_charges', 0)); ?>") || 0,
                    round_off: '0.00'
                },
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/purchases/create.blade.php ENDPATH**/ ?>