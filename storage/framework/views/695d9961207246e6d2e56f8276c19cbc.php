...
<title><?php echo e($config['store_name']); ?> — Closed</title>
...
<div class="relative z-10 text-center max-w-xl px-6">
    ...
    <?php if($config['show_logo'] && $config['logo_url']): ?>
        <div class="flex justify-center mb-6">
            <img src="<?php echo e($config['logo_url']); ?>" class="h-14">
        </div>
    <?php endif; ?>
    ...
    <!-- ETA -->
    <?php if($config['show_eta']): ?>
        <p class="text-sm text-gray-400 mb-8">
            Expected: <span class="text-white font-semibold"><?php echo e($config['eta']); ?></span>
        </p>
    <?php endif; ?>
    ...
    <div class="flex justify-center gap-4">
        ...
        <a href="<?php echo e($config['home_url']); ?>"
...
</html><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\yesteday\resources\views/storefront/maintenance.blade.php ENDPATH**/ ?>