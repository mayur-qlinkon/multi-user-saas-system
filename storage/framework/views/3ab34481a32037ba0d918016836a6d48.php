            ...
            <div class="p-6 md:p-10 print:px-8 print:py-4">
                    ...
                    <div class="w-full md:w-auto text-left md:text-right print:text-right text-sm text-gray-800 flex flex-col items-start md:items-end print:items-end">
                        ...
                        <div class="mt-1 text-[13px] text-gray-600 leading-relaxed">
                            <?php if($company->gst_number || $company->gstin): ?>
                                GSTIN: <span class="text-gray-900 font-bold uppercase"><?php echo e($company->gst_number ?? $company->gstin); ?></span><br>
                            <?php endif; ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 print:grid-cols-2 gap-8 mb-10 text-sm text-gray-800">
                    ...
                    <div class="bg-gray-50 md:bg-transparent print:bg-transparent p-4 md:p-0 rounded-lg md:rounded-none space-y-1.5 text-[13px]">
                        <div class="grid grid-cols-2"><span class="font-bold text-gray-500">Place of Supply:</span> <span class="font-bold text-right md:text-left print:text-right"><?php echo e($quotation->supply_state); ?> (<?php echo e($stateCode); ?>)</span></div>
                        <div class="grid grid-cols-2"><span class="font-bold text-gray-500">Quotation Type:</span> <span class="font-bold text-right md:text-left print:text-right"><?php echo e($quoteType); ?></span></div>
                        <div class="grid grid-cols-2">
                            <span class="font-bold text-gray-500">Status:</span> 
                            <span class="font-bold uppercase text-right md:text-left print:text-right <?php echo e($quotation->status === 'converted' ? 'text-indigo-600' : ($quotation->status === 'rejected' ? 'text-red-500' : 'text-[#108c2a]')); ?>"><?php echo e($quotation->status); ?></span>
                        </div>
                        <?php if($quotation->reference_number): ?>
                            <div class="grid grid-cols-2"><span class="font-bold text-gray-500">Reference / PO:</span> <span class="font-bold text-right md:text-left print:text-right"><?php echo e($quotation->reference_number); ?></span></div>
                        <?php endif; ?>
                    </div>
                </div>
                                    ...
                                    <td class="py-4 px-4 text-center text-gray-600 align-top">
                                        <?php if($item->discount_amount > 0): ?>
                                            <?php if($item->discount_type === 'percentage'): ?>
                                                <div class="font-bold text-gray-800"><?php echo e((float) $item->discount_value); ?>%</div>
                                                <div class="text-[11px] text-gray-500 mt-0.5">(-₹<?php echo e($formatAmt($item->discount_amount)); ?>)</div>
                                            <?php else: ?>
                                                <div class="font-bold text-gray-800">₹<?php echo e($formatAmt($item->discount_amount)); ?></div>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            -
                                        <?php endif; ?>
                            ...
                            <tbody>
                                ...
                                <?php if($quotation->igst_amount > 0): ?>
                                    <tr>
                                        ...
                                        <td class="py-2 text-right font-bold">₹<?php echo e($formatAmt($quotation->igst_amount)); ?></td>
                                    </tr>
                                <?php else: ?>
                                    <?php if($quotation->cgst_amount > 0 || $quotation->sgst_amount > 0): ?>
                                        <tr>
                                            <td class="py-2 text-gray-600 font-medium">CGST</td>
                                            <td class="py-2 text-right font-bold">₹<?php echo e($formatAmt($quotation->cgst_amount)); ?></td>
                                        </tr>
                                        <tr>
                                            <td class="py-2 text-gray-600 font-medium">SGST</td>
                                            <td class="py-2 text-right font-bold">₹<?php echo e($formatAmt($quotation->sgst_amount)); ?></td>
                                        </tr>
                                    <?php endif; ?>
                                <?php endif; ?>
                                ...
                                <?php if($quotation->shipping_charge > 0): ?>
                                    <tr>
                                        ...
                                        <td class="py-2 text-right font-bold">₹<?php echo e($formatAmt($quotation->shipping_charge)); ?></td>
                                    </tr>
                                <?php endif; ?>
                                    ...
                                    <tr>
                                        <td class="py-2 text-gray-600 font-medium">
                                            ...
                                            <?php if($quotation->discount_type === 'percentage'): ?>
                                                <span class="text-xs text-gray-500 ml-1">(<?php echo e((float) $quotation->discount_value); ?>%)</span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="py-2 text-right font-bold text-red-600">(-) ₹<?php echo e($formatAmt($quotation->discount_amount)); ?></td>
                                    </tr>
                                <?php endif; ?>

                                <tr class="border-t-2 border-gray-900">
                                    <td class="py-3 text-base font-black uppercase text-gray-900">Grand Total</td>
                                    <td class="py-3 text-right text-[17px] font-black text-[#108c2a]">₹<?php echo e($formatAmt($quotation->grand_total)); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/quotations/show.blade.php ENDPATH**/ ?>