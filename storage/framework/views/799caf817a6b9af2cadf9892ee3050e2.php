<?php $__env->startSection('title', 'Edit Purchase Return'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="pb-10" x-data="purchaseReturnForm(<?php echo \Illuminate\Support\Js::from($purchaseReturn)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($purchaseReturn->purchase)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($units ?? [])->toHtml() ?>)">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-[13px] text-gray-500 font-medium">Update return quantities and reasons for PO: <span
                        class="font-bold text-gray-700"><?php echo e($purchaseReturn->purchase->purchase_number); ?></span></p>
            </div>
        </div>
        ...
        <?php if($purchaseReturn->status === 'returned'): ?>
        ...
        <form action="<?php echo e(route('admin.purchase-returns.update', $purchaseReturn->id)); ?>" method="POST"
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="return_date"
                            value="<?php echo e(old('return_date', $purchaseReturn->return_date->format('Y-m-d'))); ?>" required
                    ...
                    <div>
                        ...
                        <select name="status" required
                            ...
                            <option value="draft"
                                <?php echo e(old('status', $purchaseReturn->status) == 'draft' ? 'selected' : ''); ?>>Draft</option>
                            <option value="returned"
                                <?php echo e(old('status', $purchaseReturn->status) == 'returned' ? 'selected' : ''); ?>>Returned
                                (Deducts Stock)</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 flex flex-col gap-5">
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <textarea name="reason" rows="3"
                            ...
                            placeholder="Provide a detailed reason for the return..."><?php echo e(old('reason', $purchaseReturn->reason)); ?></textarea>
                    </div>
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <textarea name="supplier_credit_note_number" rows="2"
                            class="w-full border border-gray-300 rounded p-3 text-sm focus:border-[#108c2a] outline-none resize-y transition-colors"
                            placeholder="Enter credit note references, terms, or supplier communication details..."><?php echo e(old('supplier_credit_note_number', $purchaseReturn->supplier_credit_note_number)); ?></textarea>
                    </div>
                ...
                async selectPO(po) {
                    ...
                    try {
                        let response = await fetch(
                            `/admin/api/purchases/${po.id}/for-return?exclude_return_id=${this.header.purchase_id ? '<?php echo e($purchaseReturn->id); ?>' : ''}`
                        );
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/purchase-returns/edit.blade.php ENDPATH**/ ?>