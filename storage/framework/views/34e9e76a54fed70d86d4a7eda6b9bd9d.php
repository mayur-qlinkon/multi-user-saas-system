                ...
                <?php $__empty_1 = true; $__currentLoopData = $returns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $return): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="p-4 hover:bg-gray-50/50 transition-colors flex flex-col gap-3">
                        ...
                        <div class="flex justify-between items-start gap-2">
                            <div class="min-w-0">
                                <a href="<?php echo e(route('admin.challan-returns.show', $return->id)); ?>" class="font-extrabold text-[#108c2a] text-[14px] hover:underline block truncate">
                                    <?php echo e($return->return_number); ?>
                            ...
                            <span class="px-2 py-0.5 rounded-md text-[9px] font-extrabold uppercase tracking-wider border <?php echo e($c); ?> shrink-0">
                                <?php echo e($return->condition_label); ?>
                        ...
                        <div class="flex flex-col gap-2 bg-gray-50/80 px-3 py-2.5 rounded-lg border border-gray-100">
                            <div class="flex justify-between items-center">
                                ...
                                <?php if($return->challan): ?>
                                    <a href="<?php echo e(route('admin.challans.show', $return->challan_id)); ?>" class="font-bold text-blue-600 text-[12px] hover:underline">
                                        <?php echo e($return->challan->challan_number); ?>

                                    </a>
                                <?php else: ?>
                                    <span class="font-bold text-red-400 text-[12px] italic">Deleted (ID: <?php echo e($return->challan_id); ?>)</span>
                                <?php endif; ?>
                            </div>
                            <div class="flex justify-between items-center pt-1 border-t border-gray-100/50">
                                <div class="flex items-center gap-2 text-[11px] text-gray-600">
                                    ...
                                    <span class="font-black text-gray-800"><?php echo e((float) $return->total_qty_returned); ?></span>
                                </div>
                                <?php if($return->total_qty_damaged > 0): ?>
                        ...
                        <div class="flex items-center justify-between pt-1">
                            ...
                            <div class="flex items-center justify-end gap-2">
                                <?php if(has_permission('challan_returns.view')): ?>
                                    <a href="<?php echo e(route('admin.challan-returns.show', $return->id)); ?>" class="w-8 h-8 rounded-lg border border-gray-200 text-gray-600 hover:bg-gray-50 flex items-center justify-center transition-colors" title="View Return">
                                        <i data-lucide="eye" class="w-4 h-4"></i>
                                    </a>
                                <?php endif; ?>

                                <?php if(has_permission('challan_returns.download_pdf')): ?>
                                    <a href="<?php echo e(route('admin.challan-returns.pdf', $return->id)); ?>" target="_blank" class="w-8 h-8 rounded-lg border border-indigo-200 text-indigo-600 hover:bg-indigo-50 flex items-center justify-center transition-colors" title="Download PDF">
                                        <i data-lucide="download" class="w-4 h-4"></i>
                                    </a>
                                <?php endif; ?>

                                <?php if(has_permission('challan_returns.update')): ?>
                                    <a href="<?php echo e(route('admin.challan-returns.edit', $return->id)); ?>" class="w-8 h-8 rounded-lg border border-blue-200 text-blue-500 hover:bg-blue-50 flex items-center justify-center transition-colors" title="Edit Return Notes">
                                        <i data-lucide="pencil" class="w-4 h-4"></i>
                                    </a>
                                <?php endif; ?>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/challan-returns/index.blade.php ENDPATH**/ ?>