<?php $__env->startSection('title', 'Add Staff Member - Qlinkon BIZNESS'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="pb-10 w-full">
        ...
        <form action="<?php echo e(route('admin.users.store')); ?>" method="POST" class="w-full bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <?php echo csrf_field(); ?>
            ...
            <div class="p-6 md:p-8 border-b border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" required placeholder="e.g. Jane Doe"
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="jane@example.com"
                            class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="status" required class="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all bg-white shadow-sm appearance-none">
                            <option value="active" <?php if(old('status', 'active') == 'active'): echo 'selected'; endif; ?>>Active (Can Login)</option>
                            <option value="inactive" <?php if(old('status') == 'inactive'): echo 'selected'; endif; ?>>Inactive (Suspended)</option>
                        </select>
                    </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <label class="block relative cursor-pointer group">
                            ...
                            <input type="checkbox" name="store_ids[]" value="<?php echo e($store->id); ?>" class="peer sr-only" 
                                <?php if(is_array(old('store_ids')) && in_array($store->id, old('store_ids'))): echo 'checked'; endif; ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/users/create.blade.php ENDPATH**/ ?>