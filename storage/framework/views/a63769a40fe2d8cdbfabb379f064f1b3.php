...
<?php $__env->startSection('content'); ?>
    <div class="pb-10" x-data="purchaseForm(<?php echo \Illuminate\Support\Js::from($units ?? [])->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($purchase)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($purchase->items)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($batchEnabled ?? false)->toHtml() ?>)">
        <div class="mb-6">
            <h1 class="text-[1.5rem] font-bold text-[#212538] tracking-tight mb-1">Edit Purchase Order</h1>
        </div>
                    ...
                    <div>
                        ...
                        <select name="status" required
                            ...
                            <option value="partially_received"
                                <?php echo e(old('status', $purchase->status) == 'partially_received' ? 'selected' : ''); ?>>Partially
                                Received</option>
    ...
    <script>
        function purchaseForm(allUnits = [], purchaseData = {}, dbItems = [], batchEnabled = false) {
            ...
            return {
                ...
                global: {
                    discount: parseFloat("<?php echo e(old('discount_amount')); ?>" !== "" ? "<?php echo e(old('discount_amount')); ?>" :
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/purchases/edit.blade.php ENDPATH**/ ?>