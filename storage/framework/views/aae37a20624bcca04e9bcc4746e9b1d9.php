...
<?php $__env->startSection('title', $store->name . ' - Store Details'); ?>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div class="flex items-center gap-3 sm:gap-4">
                <div class="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl border border-gray-200 overflow-hidden bg-white shadow-sm shrink-0">
                    <img src="<?php echo e($store->logo_url); ?>" alt="Logo" class="w-full h-full object-cover">
                </div>
                <div>
                    <div class="flex items-center gap-2">
                        <h2 class="text-lg sm:text-2xl font-black text-gray-800 tracking-tight"><?php echo e($store->name); ?></h2>
                    ...
                    <p class="text-[11px] sm:text-xs text-gray-500 font-medium mt-0.5 flex items-center gap-1">
                        <i data-lucide="calendar" class="w-3 h-3"></i> Registered on <?php echo e($store->created_at->format('M d, Y')); ?>
            ...
            <div class="bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                        ...
                        <span class="block text-[13px] sm:text-sm font-bold text-gray-800"><?php echo e($store->email ?? 'Not provided'); ?></span>
                    </div>
                    <div>
                        <span class="block text-[10px] sm:text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Contact Phone</span>
                        <span class="block text-[13px] sm:text-sm font-bold text-gray-800"><?php echo e($store->phone ?? 'Not provided'); ?></span>
                    </div>
                    <div class="sm:col-span-2">
                        ...
                        <span class="inline-block bg-gray-50 border border-gray-200 text-gray-600 px-2 py-1 rounded text-xs font-mono"><?php echo e($store->slug); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-5">
                    <div>
                        ...
                        <span class="block text-[13px] sm:text-sm font-bold text-gray-800"><?php echo e($store->city ?? 'N/A'); ?></span>
                    </div>
                    <div>
                        <span class="block text-[10px] sm:text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">State</span>
                        <span class="block text-[13px] sm:text-sm font-bold text-gray-800"><?php echo e($store->state->name ?? 'N/A'); ?></span>
                    </div>
                    <div>
                        <span class="block text-[10px] sm:text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Pincode / Zip</span>
                        <span class="block text-[13px] sm:text-sm font-bold text-gray-800"><?php echo e($store->zip_code ?? 'N/A'); ?></span>
                    </div>
                    <div>
                        <span class="block text-[10px] sm:text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Country</span>
                        <span class="block text-[13px] sm:text-sm font-bold text-gray-800"><?php echo e($store->country ?? 'India'); ?></span>
                    </div>
                </div>
                <div>
                    ...
                    <p class="text-[13px] sm:text-sm font-bold text-gray-800 bg-gray-50 p-3 rounded-xl border border-gray-100 leading-relaxed">
                        <?php echo e($store->address ?? 'No detailed address provided.'); ?>
                ...
                <div class="lg:col-span-2 bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-6">
                        <div>
                            ...
                            <span class="block text-[13px] sm:text-sm font-bold font-mono text-gray-800"><?php echo e($store->getRawOriginal('gst_number') ?: 'Using Global'); ?></span>
                        </div>
                        <div>
                            <span class="block text-[10px] sm:text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Store UPI ID</span>
                            <span class="block text-[13px] sm:text-sm font-bold text-gray-800"><?php echo e($store->getRawOriginal('upi_id') ?: 'Using Global'); ?></span>
                        </div>
                        <div>
                            <span class="block text-[10px] sm:text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Currency</span>
                            <span class="block text-[13px] sm:text-sm font-bold text-gray-800"><?php echo e($store->currency); ?></span>
                        </div>
                        <div>
                            <span class="block text-[10px] sm:text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Invoice Prefix</span>
                            <span class="block text-[13px] sm:text-sm font-bold font-mono text-gray-800"><?php echo e($store->getRawOriginal('invoice_prefix') ?: 'Using Global (' . $store->invoice_prefix . ')'); ?></span>
                        </div>
                        <div>
                            <span class="block text-[10px] sm:text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Quotation Prefix</span>
                            <span class="block text-[13px] sm:text-sm font-bold font-mono text-gray-800"><?php echo e($store->getRawOriginal('quotation_prefix') ?: 'Using Global (' . $store->quotation_prefix . ')'); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-1 bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <span class="block text-[13px] sm:text-sm font-bold text-gray-800"><?php echo e($store->getRawOriginal('bank_name') ?: 'Using Global Settings'); ?></span>
                        </div>
                        <div>
                            <span class="block text-[10px] sm:text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Account Number</span>
                            <span class="block text-[13px] sm:text-sm font-bold font-mono text-gray-800"><?php echo e($store->getRawOriginal('account_number') ?: '-'); ?></span>
                        </div>
                        <div>
                            <span class="block text-[10px] sm:text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">IFSC & Branch</span>
                            <span class="block text-[13px] sm:text-sm font-bold text-gray-800"><?php echo e($store->getRawOriginal('ifsc_code') ?: '-'); ?> • <?php echo e($store->getRawOriginal('branch_name') ?: '-'); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-3 bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div class="lg:col-span-2 space-y-5">
                            <div>
                                ...
                                <div class="text-[12px] sm:text-[13px] text-gray-700 bg-gray-50 p-3 rounded-xl border border-gray-100 italic">
                                    <?php echo e($store->getRawOriginal('invoice_footer_note') ?: 'Using global footer note. Set locally to override.'); ?>
                            ...
                            <div>
                                ...
                                <div class="text-[12px] sm:text-[13px] text-gray-700 bg-gray-50 p-3 rounded-xl border border-gray-100 whitespace-pre-line">
                                    <?php echo e($store->getRawOriginal('invoice_terms') ?: 'Using global terms and conditions. Set locally to override.'); ?>
                        ...
                        <div class="lg:col-span-1 border-t lg:border-t-0 lg:border-l border-gray-100 pt-5 lg:pt-0 lg:pl-6 flex flex-col items-start lg:items-center justify-center">
                            ...
                            <?php if($store->signature_url): ?>
                                <div class="w-48 h-20 border border-gray-200 rounded-xl p-2 bg-white shadow-sm flex items-center justify-center">
                                    <img src="<?php echo e($store->signature_url); ?>" alt="Signature" class="max-w-full max-h-full object-contain">
                                </div>
                                <?php if(!$store->getRawOriginal('signature')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/stores/show.blade.php ENDPATH**/ ?>