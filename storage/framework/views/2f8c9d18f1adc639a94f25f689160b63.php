            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="space-y-4">
                    ...
                    <div x-show="productGuides.length === 0"
                        ...
                        <p class="text-xs text-gray-400 mt-1">Click "Add Section" to provide helpful product information.
                        </p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/products/create.blade.php ENDPATH**/ ?>