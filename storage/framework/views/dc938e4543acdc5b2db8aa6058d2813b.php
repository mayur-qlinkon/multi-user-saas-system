...
<div class="pb-10"
    ...
    <div class="flex items-center justify-between flex-wrap gap-3 mb-5">
        ...
        <div class="flex items-center gap-2 flex-wrap w-full sm:w-auto">
            ...
            <?php if($lead->phone): ?>
                <a href="<?php echo e($lead->whatsapp_url); ?>" target="_blank" class="action-btn success flex-1 sm:flex-none justify-center">
            ...
            <a href="<?php echo e(route('admin.crm.leads.edit', $lead->id)); ?>" class="action-btn flex-1 sm:flex-none justify-center">
            ...
            <?php if(!$lead->is_converted): ?>
                <?php if(has_permission('crm_leads.convert')): ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 xl:grid-cols-3 gap-5">
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <?php if($lead->pipeline): ?>
                <div class="detail-card">
                    ...
                    <div class="px-5 py-5">
                        ...
                        <?php if(has_permission('crm_leads.change_stage')): ?>
            ...
            <?php if(has_permission('crm_tasks.view')): ?>
                <div class="detail-card flex flex-col" x-data="tasksPanel()">
                    ...
                    <div class="card-title flex items-center justify-between border-b border-gray-50 bg-white">
                        ...
                        <?php if(has_permission('crm_tasks.create')): ?>
                    ...
                    <div class="flex flex-col divide-y divide-gray-50/80">
                        <template x-for="task in tasks" :key="task.id">
                            <div class="group flex items-start gap-3.5 p-5 hover:bg-slate-50/40 transition-colors">
                                ...
                                <?php if(has_permission('crm_tasks.complete')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/crm/leads/show.blade.php ENDPATH**/ ?>