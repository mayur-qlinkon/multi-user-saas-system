<?php $__env->startSection('title', 'Edit Warehouse - Qlinkon BIZNESS'); ?>

<?php $__env->startSection('header-title'); ?>
    <h1 class="text-xs sm:text-sm font-bold text-gray-400 uppercase tracking-widest">Inventory / Edit Warehouse</h1>
...
<?php $__env->startSection('content'); ?>
    <div class="w-full mx-auto space-y-6 pb-10" x-data="warehouseEditForm()">
        ...
        <form action="<?php echo e(route('admin.warehouses.update', $warehouse->id)); ?>" method="POST" class="space-y-6" @submit="isSubmitting = true">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name', $warehouse->name)); ?>" required placeholder="e.g. Main Godown"
                    ...
                    <div>
                        ...
                        <select name="store_id" required
                            ...
                            <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($store->id); ?>" <?php echo e(old('store_id', $warehouse->store_id) == $store->id ? 'selected' : ''); ?>>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" name="contact_person" value="<?php echo e(old('contact_person', $warehouse->contact_person)); ?>" placeholder="John Doe"
                            class="w-full border border-gray-300 rounded-md px-3.5 py-2.5 text-sm focus:border-[#108c2a] focus:ring-1 focus:ring-[#108c2a] outline-none transition-all">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email', $warehouse->email)); ?>" placeholder="warehouse@example.com"
                            class="w-full border border-gray-300 rounded-md px-3.5 py-2.5 text-sm focus:border-[#108c2a] focus:ring-1 focus:ring-[#108c2a] outline-none transition-all">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="city" value="<?php echo e(old('city', $warehouse->city)); ?>" placeholder="e.g. Ahmedabad"
                            class="w-full border border-gray-300 rounded-md px-3.5 py-2.5 text-sm focus:border-[#108c2a] focus:ring-1 focus:ring-[#108c2a] outline-none transition-all">
                    </div>
                    <div>
                        ...
                        <select name="state_id"
                            ...
                            <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($state->id); ?>" <?php echo e(old('state_id', $warehouse->state_id) == $state->id ? 'selected' : ''); ?>>
                ...
                <div>
                    ...
                    <textarea name="address" rows="2" placeholder="Exact storage site location..."
                        class="w-full border border-gray-300 rounded-md px-3.5 py-2.5 text-sm focus:border-[#108c2a] focus:ring-1 focus:ring-[#108c2a] outline-none transition-all resize-y"><?php echo e(old('address', $warehouse->address)); ?></textarea>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="flex flex-col sm:flex-row gap-8">
                    ...
                    <label class="inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="is_default" value="1" class="sr-only peer" <?php echo e(old('is_default', $warehouse->is_default) ? 'checked' : ''); ?>>
                    ...
                    <label class="inline-flex items-center cursor-pointer">
                        ...
                        <input type="checkbox" name="is_active" value="1" class="sr-only peer" <?php echo e(old('is_active', $warehouse->is_active) ? 'checked' : ''); ?>>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        function warehouseEditForm() {
            return {
                isSubmitting: false,
                phone: '<?php echo e(old('phone', $warehouse->phone)); ?>',
                zip: '<?php echo e(old('zip_code', $warehouse->zip_code)); ?>',
            }
        }
    </script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/warehouses/edit.blade.php ENDPATH**/ ?>