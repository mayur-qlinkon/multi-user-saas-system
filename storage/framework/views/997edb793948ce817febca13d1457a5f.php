                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="page-row flex flex-col md:table-row p-4 md:p-0">
                            ...
                            <td class="px-0 md:px-6 py-2 md:py-4 flex md:table-cell items-center justify-between md:justify-start">
                                ...
                                <?php if(has_permission('pages.toggle_publish')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/storefront-sections/pages/index.blade.php ENDPATH**/ ?>