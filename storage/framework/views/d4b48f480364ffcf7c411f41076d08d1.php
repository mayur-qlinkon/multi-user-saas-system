...
<title><?php echo e($config['store_name']); ?> — <?php echo e($config['badge_text']); ?></title>
...
<div class="relative z-10 text-center max-w-3xl px-6 py-12">
    ...
    <!-- logo -->
    <?php if($config['show_logo'] && $config['logo_url']): ?>
        <div class="flex justify-center mb-8">
            <img src="<?php echo e($config['logo_url']); ?>" class="h-16 drop-shadow-lg" alt="<?php echo e($config['store_name']); ?>">
        </div>
    <?php endif; ?>
    ...
    <div class="grid sm:grid-cols-2 gap-4 max-w-2xl mx-auto mb-10">
        ...
        <!-- Email Card -->
        <a href="mailto:<?php echo e($supportEmail); ?>" class="group block bg-white/5 border border-white/10 hover:border-indigo-400/50 hover:bg-white/10 rounded-2xl p-6 backdrop-blur-md transition duration-300 text-left">
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-indigo-300 text-sm font-medium break-all"><?php echo e($supportEmail); ?></p>
                </div>
            </div>
        </a>

        <!-- Phone Card -->
        <a href="tel:<?php echo e($supportPhone); ?>" class="group block bg-white/5 border border-white/10 hover:border-emerald-400/50 hover:bg-white/10 rounded-2xl p-6 backdrop-blur-md transition duration-300 text-left">
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-emerald-300 text-sm font-medium"><?php echo e($supportPhone); ?></p>
                </div>
            </div>
        </a>
    ...
    <div class="flex flex-col sm:flex-row justify-center gap-4">
        <button onclick="location.reload()"
            ...
            style="background: <?php echo e($config['primary_color']); ?>">
            Try Reloading Page
        </button>
...
</html><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\yesteday\resources\views/maintenance.blade.php ENDPATH**/ ?>