<?php $__env->startSection('title', 'Create Purchase Return'); ?>
<?php $__env->startSection('header-title'); ?>
    <h1 class="text-sm font-bold text-gray-500 uppercase tracking-widest">Create Purchase Return</h1>
...
<?php $__env->startSection('content'); ?>
    <div class="pb-10" x-data="purchaseReturnForm(<?php echo \Illuminate\Support\Js::from($originalPurchase ?? null)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($units ?? [])->toHtml() ?>)">
        ...
        <form action="<?php echo e(route('admin.purchase-returns.store')); ?>" method="POST"
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
                <div class="p-6 grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="return_date" value="<?php echo e(old('return_date', date('Y-m-d'))); ?>" required
                    ...
                    <div>
                        ...
                        <select name="status" required
                            ...
                            <option value="returned" <?php echo e(old('status') == 'returned' ? 'selected' : ''); ?>>Returned (Deducts
                                Stock)</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 flex flex-col gap-5">
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <textarea name="reason" rows="3"
                            ...
                            placeholder="Provide a detailed reason for the return..."><?php echo e(old('reason')); ?></textarea>
                    </div>
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <textarea name="supplier_credit_note_number" rows="2"
                            class="w-full border border-gray-300 rounded p-3 text-sm focus:border-[#108c2a] outline-none resize-y transition-colors"
                            placeholder="Enter credit note references, terms, or supplier communication details..."><?php echo e(old('supplier_credit_note_number')); ?></textarea>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/purchase-returns/create.blade.php ENDPATH**/ ?>