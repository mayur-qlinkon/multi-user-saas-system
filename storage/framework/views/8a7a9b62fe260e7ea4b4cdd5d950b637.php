<?php $__env->startSection('title', 'Edit Branch - Qlinkon BIZNESS'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="w-full mx-auto space-y-4 sm:space-y-6 pb-10" 
         x-data="storeEditForm('<?php echo e($store->logo ? asset('storage/' . $store->logo) : ''); ?>', '<?php echo e($store->signature ? asset('storage/' . $store->signature) : ''); ?>')">
        ...
        <form action="<?php echo e(route('admin.stores.update', $store->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-5 sm:space-y-6" @submit="isSubmitting = true">
            <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name', $store->name)); ?>" required placeholder="e.g. Downtown Hub"
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="<?php echo e(old('email', $store->email)); ?>" placeholder="branch@company.com"
                                class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                        </div>
                        <div>
            ...
            <div class="bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-4 sm:mb-5">
                    <div>
                        ...
                        <input type="text" name="city" value="<?php echo e(old('city', $store->city)); ?>" placeholder="e.g. Ahmedabad"
                            class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                    </div>
                    <div>
                        ...
                        <select name="state_id"
                            ...
                            <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($state->id); ?>" <?php echo e(old('state_id', $store->state_id) == $state->id ? 'selected' : ''); ?>><?php echo e($state->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea name="address" rows="2" placeholder="Shop number, building, street, landmark..."
                        class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all resize-y shadow-sm"><?php echo e(old('address', $store->address)); ?></textarea>
                </div>
            </div>
                ...
                <div class="bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                            <div>
                                ...
                                <input type="text" name="gst_number" value="<?php echo e(old('gst_number', $store->gst_number)); ?>" placeholder="24AAAAA0000A1Z5" maxlength="15"
                            ...
                            <div>
                                ...
                                <input type="text" name="upi_id" value="<?php echo e(old('upi_id', $store->upi_id)); ?>" placeholder="store@bank"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                            </div>
                            <div>
                                ...
                                <select name="currency" class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm font-bold text-gray-700 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none bg-white shadow-sm">
                                    <option value="INR" <?php echo e(old('currency', $store->currency) == 'INR' ? 'selected' : ''); ?>>₹ INR (Rupee)</option>
                                    <option value="USD" <?php echo e(old('currency', $store->currency) == 'USD' ? 'selected' : ''); ?>>$ USD (Dollar)</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-[11px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Invoice Prefix</label>
                                <input type="text" name="invoice_prefix" value="<?php echo e(old('invoice_prefix', $store->getRawOriginal('invoice_prefix'))); ?>" placeholder="e.g. BOM-INV-"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm uppercase font-mono focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                            </div>
                            <div>
                                <label class="block text-[11px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Quotation Prefix</label>
                                <input type="text" name="quotation_prefix" value="<?php echo e(old('quotation_prefix', $store->getRawOriginal('quotation_prefix'))); ?>" placeholder="e.g. BOM-QTN-"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm uppercase font-mono focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                            </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                            <div class="sm:col-span-2 lg:col-span-1">
                                ...
                                <input type="text" name="bank_name" value="<?php echo e(old('bank_name', $store->getRawOriginal('bank_name'))); ?>" placeholder="e.g. HDFC Bank"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                            </div>
                            <div class="sm:col-span-1">
                                <label class="block text-[11px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Account Name</label>
                                <input type="text" name="account_name" value="<?php echo e(old('account_name', $store->getRawOriginal('account_name'))); ?>" placeholder="e.g. Acme Corp Ltd"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                            </div>
                            <div class="sm:col-span-1">
                                <label class="block text-[11px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Account Number</label>
                                <input type="text" name="account_number" value="<?php echo e(old('account_number', $store->getRawOriginal('account_number'))); ?>" placeholder="e.g. 502000123456"
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <input type="text" name="ifsc_code" value="<?php echo e(old('ifsc_code', $store->getRawOriginal('ifsc_code'))); ?>" placeholder="e.g. HDFC0001234"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm uppercase font-mono focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                            </div>
                            <div class="sm:col-span-1">
                                <label class="block text-[11px] sm:text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Branch Name</label>
                                <input type="text" name="branch_name" value="<?php echo e(old('branch_name', $store->getRawOriginal('branch_name'))); ?>" placeholder="e.g. CG Road Branch"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all shadow-sm">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea name="invoice_footer_note" rows="2" placeholder="e.g. Thank you for your business!"
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all resize-y shadow-sm"><?php echo e(old('invoice_footer_note', $store->getRawOriginal('invoice_footer_note'))); ?></textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="invoice_terms" rows="3" placeholder="1. Goods once sold will not be taken back..."
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-all resize-y shadow-sm"><?php echo e(old('invoice_terms', $store->getRawOriginal('invoice_terms'))); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100">
                        <h2 class="text-sm sm:text-base font-bold text-gray-800 mb-4 border-b border-gray-100 pb-2 flex items-center gap-2">
                            ...
                            <a href="/<?php echo e(auth()->user()->company?->slug); ?>/<?php echo e($store->slug); ?>" target="_blank"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="sm:col-span-2 flex items-center gap-3 p-3 bg-gray-50 rounded-xl border border-gray-200">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="storefront_enabled" value="1"
                                        <?php echo e(old('storefront_enabled', $store->storefront_enabled) ? 'checked' : ''); ?>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="tagline" value="<?php echo e(old('tagline', $store->tagline)); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" name="whatsapp" value="<?php echo e(old('whatsapp', $store->whatsapp)); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" name="business_hours" value="<?php echo e(old('business_hours', $store->business_hours)); ?>"
                            ...
                            <div>
                                ...
                                <input type="url" name="instagram" value="<?php echo e(old('instagram', $store->instagram)); ?>"
                            ...
                            <div>
                                ...
                                <input type="url" name="facebook" value="<?php echo e(old('facebook', $store->facebook)); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" name="seo_title" value="<?php echo e(old('seo_title', $store->seo_title)); ?>"
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="seo_description" maxlength="300"
                                    ...
                                    class="w-full border border-gray-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-brand-500 outline-none resize-none" rows="2"><?php echo e(old('seo_description', $store->seo_description)); ?></textarea>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white p-5 sm:p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 sticky bottom-0 z-20">
                ...
                <label class="inline-flex items-center cursor-pointer shrink-0">
                    ...
                    <input type="checkbox" name="is_active" value="1" class="sr-only peer" <?php echo e(old('is_active', $store->is_active) ? 'checked' : ''); ?>>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        function storeEditForm(initialLogo, initialSignature) {
            return {
                isSubmitting: false,
                phone: '<?php echo e(old('phone', $store->phone)); ?>',
                zip: '<?php echo e(old('zip_code', $store->zip_code)); ?>',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/stores/edit.blade.php ENDPATH**/ ?>