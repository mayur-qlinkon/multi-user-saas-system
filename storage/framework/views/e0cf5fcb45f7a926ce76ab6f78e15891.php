...
<?php $__env->startSection('content'); ?>
    ...
    <div class="pb-20" x-data="invoiceForm(<?php echo \Illuminate\Support\Js::from($units ?? [])->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($companyState)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($clients ?? [])->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($challanPrefillJs ?? null)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($orderPrefillJs ?? null)->toHtml() ?>)">
        ...
        <form id="mainInvoiceForm" action="<?php echo e(route('admin.invoices.store')); ?>" method="POST"
            ...
            <?php if($orderPrefill): ?>
                ...
                <input type="hidden" name="order_id" value="<?php echo e($orderPrefill->id); ?>">
                ...
                <div class="bg-violet-50 border border-violet-200 rounded-lg p-4 mb-6 flex flex-col sm:flex-row items-start sm:items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-violet-600 font-medium">
                            Order <span class="font-black"><?php echo e($orderPrefill->order_number); ?></span> —
                            <?php echo e($orderPrefill->items->count()); ?> item(s) pre-loaded.
                            Customer: <span class="font-black"><?php echo e($orderPrefill->customer_name); ?></span>
                            <?php if($orderPrefill->customer_phone): ?>
                                · <?php echo e($orderPrefill->customer_phone); ?>

                            <?php endif; ?>
                            <?php if($orderPrefill->order_type === 'inquiry'): ?>
                                · <span class="text-amber-600 font-bold">Catalog order — please set prices below.</span>
                            <?php endif; ?>
                        </p>
                    </div>
                    <a href="<?php echo e(route('admin.orders.show', $orderPrefill->id)); ?>"
