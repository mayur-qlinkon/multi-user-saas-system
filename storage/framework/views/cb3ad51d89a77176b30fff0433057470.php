...
<?php $__env->startSection('content'); ?>
    <div class="pb-10" x-data="supplierCrud(<?php echo \Illuminate\Support\Js::from($suppliers->items())->toHtml() ?>)">
            ...
            <form method="GET" action="<?php echo e(route('admin.suppliers.index')); ?>"
                ...
                <div class="flex flex-col sm:flex-row sm:flex-wrap gap-2 w-full xl:flex-1 xl:max-w-3xl">
                    ...
                    <select name="registration_type"
                        ...
                        <option value="regular" <?php if(($registrationType ?? '') === 'regular'): echo 'selected'; endif; ?>>Regular</option>
                ...
                <div class="flex flex-row flex-wrap items-center gap-2 w-full xl:w-auto justify-start xl:justify-end mt-2 xl:mt-0">
                    ...
                    <?php if(has_module('bulk_import') && has_permission('suppliers.create')): ?>
                    ...
                    <div class="p-4 hover:bg-gray-50/50 transition-colors flex flex-col gap-3">
                        ...
                        <div class="flex justify-between items-start gap-2">
                            <div class="flex items-center gap-3 min-w-0">
                                ...
                                <div class="min-w-0">
                                    <p class="font-bold text-[14px] text-gray-900 truncate"><?php echo e($supplier->name); ?></p>
                                    <p class="text-[11px] text-gray-500 mt-0.5 truncate"><?php echo e($supplier->email ?? 'No email added'); ?></p>
                                </div>
                            </div>
                            <div class="shrink-0">
                                <?php if($supplier->is_active): ?>
                        ...
                        <div class="flex items-center justify-end gap-2 pt-1 border-t border-gray-50 mt-1">
                            <?php if(has_permission('suppliers.update')): ?>
                                <button type="button" @click="openEditModal(<?php echo e($supplier->toJson()); ?>)" class="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 hover:text-blue-700 flex items-center justify-center transition-colors" title="Edit">
                                    <i data-lucide="pencil" class="w-4 h-4"></i>
                                </button>
                            <?php endif; ?>

                            <?php if(has_permission('suppliers.delete')): ?>
                                <form action="<?php echo e(route('admin.suppliers.destroy', $supplier->id)); ?>" method="POST" @submit.prevent="confirmDelete($event.target)" class="inline-block">
                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/suppliers.blade.php ENDPATH**/ ?>