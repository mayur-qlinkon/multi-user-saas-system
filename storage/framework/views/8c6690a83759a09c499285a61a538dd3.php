<?php $__env->startSection('title', 'Purchases - Qlinkon BIZNESS'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="pb-10" x-data="purchaseIndex()">
        ...
        <div class="bg-white rounded-t-xl shadow-sm border border-gray-100 p-4 border-b-0">
            <form action="<?php echo e(route('admin.purchases.index')); ?>" method="GET" class="flex flex-col sm:flex-row gap-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status"
                                ...
                                <option value="partially_received"
                                    <?php echo e(request('status') == 'partially_received' ? 'selected' : ''); ?>>Partially Received
                                </option>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-col">
                                        <a href="<?php echo e(route('admin.purchases.show', $purchase->id)); ?>"
                                            ...
                                            <?php echo e($purchase->purchase_number); ?>

                                        </a>
                                        <span class="text-[11px] text-gray-500 mt-0.5 font-medium">
                                            <?php echo e($purchase->purchase_date->format('d M, Y')); ?>
                                ...
                                <td class="px-6 py-4 hidden md:table-cell">
                                    <div class="flex flex-col">
                                        <span
                                            class="font-bold text-gray-800 text-[13px]"><?php echo e($purchase->supplier->name ?? 'Unknown'); ?></span>
                                        <?php if($purchase->supplier_invoice_number): ?>
                                            <span class="text-[11px] text-gray-400 mt-0.5 font-mono">Inv:
                                                <?php echo e($purchase->supplier_invoice_number); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 hidden md:table-cell">
                                    <div class="flex flex-col">
                                        <span
                                            class="font-semibold text-gray-700 text-[12px]"><?php echo e($purchase->warehouse->name ?? 'N/A'); ?></span>
                                        <?php if($purchase->store): ?>
                                            <span
                                                class="text-[10px] text-gray-400 uppercase tracking-widest mt-0.5"><?php echo e($purchase->store->name); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center hidden md:table-cell">
                                    ...
                                    <span
                                        ...
                                        <?php echo e(str_replace('_', ' ', $purchase->status)); ?>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex flex-col items-end">
                                        <span
                                            class="font-extrabold text-gray-800">₹<?php echo e(number_format($purchase->total_amount, 2)); ?></span>
                                        <?php if($purchase->balance_amount > 0): ?>
                                            <span class="text-[10px] font-bold text-red-500 mt-0.5">Bal:
                                                ₹<?php echo e(number_format($purchase->balance_amount, 2)); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div
                                        ...
                                        <?php if($purchase->status !== 'received' && $purchase->status !== 'cancelled' && has_permission('purchases.update')): ?>
                                        ...
                                        <?php if($purchase->status !== 'cancelled' && has_permission('purchases.add_payment')): ?>
                                            <button type="button"
                                                @click="openPaymentModal(<?php echo e($purchase->id); ?>, '<?php echo e($purchase->payment_status); ?>', <?php echo e($purchase->total_amount); ?>, <?php echo e($purchase->balance_amount); ?>)"
                    ...
                    <div class="p-4 hover:bg-gray-50/50 transition-colors flex flex-col gap-3">
                        ...
                        <div class="flex justify-between items-start gap-2">
                            <div class="min-w-0 flex-1">
                                <p class="font-bold text-gray-800 text-[14px] truncate">
                                    <?php echo e($purchase->supplier->name ?? 'Unknown'); ?>

                                </p>
                                <?php if($purchase->supplier_invoice_number): ?>
                                    <p class="text-[11px] text-gray-400 mt-0.5 font-mono truncate">
                                        Inv: <?php echo e($purchase->supplier_invoice_number); ?>

                                    </p>
                                <?php else: ?>
                                    <p class="text-[11px] text-gray-400 mt-0.5 font-medium truncate">
                                        <?php echo e($purchase->warehouse->name ?? 'N/A'); ?>

                                    </p>
                                <?php endif; ?>
                            </div>
                            <div class="text-right shrink-0 flex flex-col items-end">
                                <span class="font-black text-gray-800 text-[15px]">₹<?php echo e(number_format($purchase->total_amount, 2)); ?></span>
                                <?php if($purchase->balance_amount > 0): ?>
                                    <span class="text-[10px] font-bold text-red-500 mt-0.5">Bal: ₹<?php echo e(number_format($purchase->balance_amount, 2)); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-2 bg-gray-50/80 px-3 py-2.5 rounded-lg border border-gray-100">
                            <div class="flex justify-between items-center">
                                <a href="<?php echo e(route('admin.purchases.show', $purchase->id)); ?>" class="font-extrabold text-[#108c2a] text-[13px] hover:underline">
                                    <?php echo e($purchase->purchase_number); ?>
                            ...
                            <div class="flex flex-wrap items-center gap-2 pt-1 border-t border-gray-100/50">
                                ...
                                <?php if($purchase->store): ?>
                                    ...
                                    <span class="text-[9px] text-gray-500 uppercase tracking-widest font-semibold">
                                        <?php echo e($purchase->store->name); ?>
                        ...
                        <div class="flex items-center justify-end gap-2 pt-1 flex-wrap">
                            <?php if(has_permission('purchases.view')): ?>
                                <a href="<?php echo e(route('admin.purchases.show', $purchase->id)); ?>" class="w-8 h-8 rounded-lg border border-gray-200 text-gray-600 hover:bg-gray-50 flex items-center justify-center transition-colors" title="View PO">
                                    <i data-lucide="eye" class="w-4 h-4"></i>
                                </a>
                            <?php endif; ?>

                            <?php if($purchase->status !== 'received' && $purchase->status !== 'cancelled' && has_permission('purchases.update')): ?>
                                <a href="<?php echo e(route('admin.purchases.edit', $purchase->id)); ?>" class="w-8 h-8 rounded-lg border border-blue-200 text-blue-600 hover:bg-blue-50 flex items-center justify-center transition-colors" title="Edit PO">
                                    <i data-lucide="edit" class="w-4 h-4"></i>
                                </a>
                            <?php endif; ?>

                            <?php if($purchase->status !== 'cancelled' && has_permission('purchases.add_payment')): ?>
                                <button type="button" @click="openPaymentModal(<?php echo e($purchase->id); ?>, '<?php echo e($purchase->payment_status); ?>', <?php echo e($purchase->total_amount); ?>, <?php echo e($purchase->balance_amount); ?>)" class="w-8 h-8 rounded-lg border border-green-200 text-green-600 hover:bg-green-50 flex items-center justify-center transition-colors" title="Update Payment Status">
                                    <i data-lucide="indian-rupee" class="w-4 h-4"></i>
                                </button>
                            <?php endif; ?>
                            ...
                            <?php if($purchase->status !== 'received'): ?>
                                <?php if(has_permission('purchases.delete')): ?>
                                    <form action="<?php echo e(route('admin.purchases.destroy', $purchase->id)); ?>" method="POST" @submit.prevent="confirmDelete($event.target)" class="inline-block m-0 p-0">
                                        <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
        ...
        function purchaseIndex() {
            return {
                ...
                get paymentActionUrl() {
                    ...
                    return "<?php echo e(route('admin.purchases.index')); ?>/" + this.selectedPurchaseId + "/payment";
                },
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/purchases/index.blade.php ENDPATH**/ ?>