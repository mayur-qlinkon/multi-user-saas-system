                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        ...
                                        <?php if($challan->is_returnable && $challan->status !== 'cancelled'): ?>
                                            <a href="<?php echo e(route('admin.challan-returns.create', $challan->id)); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/challans/index.blade.php ENDPATH**/ ?>