<?php $__env->startSection('title', 'Create Credit Note for ' . $invoice->invoice_number); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="pb-20" x-data="invoiceReturnForm(<?php echo \Illuminate\Support\Js::from($invoice)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($companyState)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($returnableMap)->toHtml() ?>)">

        <div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h1 class="text-[1.5rem] font-bold text-gray-500 uppercase tracking-widest1">
                    Create Return for <span class="text-[#108c2a]"><?php echo e($invoice->invoice_number); ?></span>
                </h1>
        ...
        <form id="returnForm" action="<?php echo e(route('admin.invoice-returns.store', $invoice->id)); ?>" method="POST"
            @submit="BizAlert.loading('Processing Return...')">
            <?php echo csrf_field(); ?>

            
            <input type="hidden" name="invoice_id" value="<?php echo e($invoice->id); ?>">
            <input type="hidden" name="store_id" value="<?php echo e($invoice->store_id); ?>">
            <input type="hidden" name="customer_id" value="<?php echo e($invoice->customer_id); ?>">
            <input type="hidden" name="customer_name" value="<?php echo e($invoice->customer_name); ?>">
            <input type="hidden" name="supply_state" value="<?php echo e($invoice->supply_state); ?>">
            <input type="hidden" name="gst_treatment" value="<?php echo e($invoice->gst_treatment); ?>">
                            ...
                            <select name="warehouse_id" x-model="formData.warehouse_id" required
                                ...
                                <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($warehouse->id); ?>"
                                        <?php echo e($invoice->warehouse_id == $warehouse->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/invoice-returns/create.blade.php ENDPATH**/ ?>