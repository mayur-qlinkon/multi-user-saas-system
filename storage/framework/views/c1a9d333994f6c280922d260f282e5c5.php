<?php $__env->startSection('title', 'Salary Slip'); ?>
...
<?php $__env->startSection('header-title'); ?>
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-xs text-gray-400 font-medium mt-0.5"><?php echo e($salarySlip->employee->user?->name); ?> · <?php echo e($salarySlip->slip_number); ?></p>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="flex items-start gap-5 flex-wrap">
                ...
                <div class="w-16 h-16 rounded-2xl flex items-center justify-center text-white text-xl font-black flex-shrink-0"
                    ...
                    <?php echo e(strtoupper(substr($empName, 0, 1))); ?>
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex items-start justify-between gap-4 flex-wrap">
                        <div>
                            <p class="text-[18px] font-black text-gray-900"><?php echo e($empName); ?></p>
                            <p class="text-[12px] text-gray-500 mt-0.5">
                                <?php echo e($salarySlip->employee->employee_code); ?>

                                <?php if($salarySlip->employee->department): ?>
                                    &nbsp;·&nbsp;<?php echo e($salarySlip->employee->department->name); ?>

                                <?php endif; ?>
                                <?php if($salarySlip->employee->designation): ?>
                                    &nbsp;·&nbsp;<?php echo e($salarySlip->employee->designation->name); ?>
                        ...
                        <div class="flex items-center gap-2">
                            <span class="text-[11px] font-extrabold uppercase tracking-wider px-3 py-1.5 rounded-lg"
                                ...
                                <?php echo e(\App\Models\Hrm\SalarySlip::STATUS_LABELS[$salarySlip->status]); ?>

                            </span>
                            <span class="text-[11px] font-bold text-gray-500 bg-gray-100 px-2.5 py-1.5 rounded-lg">
                                <?php echo e($salarySlip->slip_number); ?>
        ...
        <div class="card-body">
            <div class="grid grid-cols-2 sm:grid-cols-5 gap-3">
                <div class="bg-gray-50 rounded-xl px-4 py-3">
                    ...
                    <p class="text-[13px] font-black text-gray-800"><?php echo e($months[$salarySlip->month] ?? $salarySlip->month); ?> <?php echo e($salarySlip->year); ?></p>
                </div>
                <div class="bg-gray-50 rounded-xl px-4 py-3">
                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Working Days</p>
                    <p class="text-[13px] font-black text-gray-800"><?php echo e($salarySlip->working_days ?? '—'); ?></p>
                </div>
                <div class="bg-gray-50 rounded-xl px-4 py-3">
                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Present Days</p>
                    <p class="text-[13px] font-black text-green-700"><?php echo e($salarySlip->present_days ?? '—'); ?></p>
                </div>
                <div class="bg-gray-50 rounded-xl px-4 py-3">
                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Absent Days</p>
                    <p class="text-[13px] font-black text-red-600"><?php echo e($salarySlip->absent_days ?? '—'); ?></p>
                </div>
                <div class="bg-gray-50 rounded-xl px-4 py-3">
                    <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Overtime Hrs</p>
                    <p class="text-[13px] font-black text-gray-800"><?php echo e($salarySlip->overtime_hours ?? '—'); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="detail-card">
                ...
                <div class="card-body">
                    ...
                    <?php if($salarySlip->generatedByUser): ?>
                    <div class="info-row">
                        <span class="info-label">Generated By</span>
                        <span class="info-value"><?php echo e($salarySlip->generatedByUser->name); ?></span>
                    </div>
                    <?php endif; ?>
                    <?php if($salarySlip->generated_at): ?>
                    <div class="info-row">
                        <span class="info-label">Generated On</span>
                        <span class="info-value"><?php echo e($salarySlip->generated_at->format('d M Y, h:i A')); ?></span>
                    </div>
                    <?php endif; ?>
                    <?php if($salarySlip->approvedByUser): ?>
                    <div class="info-row">
                        <span class="info-label">Approved By</span>
                        <span class="info-value"><?php echo e($salarySlip->approvedByUser->name); ?></span>
                    </div>
                    <?php endif; ?>
                    <?php if($salarySlip->approved_at): ?>
                    <div class="info-row">
                    ...
                    <div class="info-row">
                        ...
                        <span class="info-value font-mono"><?php echo e($salarySlip->payment_reference); ?></span>
                    </div>
                    <?php endif; ?>
                    <?php if($salarySlip->payment_date): ?>
                    <div class="info-row">
                        <span class="info-label">Payment Date</span>
                        <span class="info-value"><?php echo e(\Carbon\Carbon::parse($salarySlip->payment_date)->format('d M Y')); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="space-y-4">
            ...
            <div class="detail-card">
                ...
                <div class="card-body">
                    <a href="<?php echo e(route('admin.hrm.salary-slips.pdf', $salarySlip)); ?>" target="_blank"
            ...
            <div class="detail-card">
                ...
                <div class="card-body">
                    <div class="info-row">
                        ...
                        <span class="info-value font-mono text-[12px]"><?php echo e($salarySlip->slip_number); ?></span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Created</span>
                        <span class="info-value"><?php echo e($salarySlip->created_at->format('d M Y')); ?></span>
                    </div>
                    <?php if($salarySlip->employee->pan_number): ?>
                    <div class="info-row">
                        <span class="info-label">PAN</span>
                        <span class="info-value font-mono text-[12px]"><?php echo e($salarySlip->employee->pan_number); ?></span>
                    </div>
                    <?php endif; ?>
                    <?php if($salarySlip->employee->bank_account_number): ?>
                    <div class="info-row">
                        <span class="info-label">Account</span>
                        <span class="info-value font-mono text-[12px]">****<?php echo e(substr($salarySlip->employee->bank_account_number, -4)); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
window.salarySlipShow = function(opts = {}) {
    ...
    return {
        ...
        async approveSlip() {
            ...
            this.saving = true;
            try {
                const resp = await fetch('<?php echo e(route("admin.hrm.salary-slips.approve", $salarySlip)); ?>', {
                    method: 'PATCH',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                        'Accept': 'application/json',
        ...
        async submitPay() {
            ...
            this.payErrors = {};
            try {
                const resp = await fetch('<?php echo e(route("admin.hrm.salary-slips.pay", $salarySlip)); ?>', {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/hrm/salary-slips/show.blade.php ENDPATH**/ ?>