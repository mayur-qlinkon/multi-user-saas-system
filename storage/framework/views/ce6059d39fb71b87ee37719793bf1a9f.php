                            ...
                            <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div>
                                    <div class="flex items-center justify-between mb-3">
                                        <p class="text-sm font-bold text-gray-800"><?php echo e($attr->name); ?></p>
                                    </div>
                                    <div class="flex flex-wrap gap-2.5">
                                        <?php $__currentLoopData = $attr->values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <label :class="(selectedValues[<?php echo e($attr->id); ?>] || []).includes('<?php echo e($val->id); ?>::<?php echo e($val->value); ?>') ? 'bg-[#108c2a] border-[#108c2a] text-white shadow-sm' : 'bg-white border-gray-300 text-gray-700 hover:bg-gray-50'" 
                                                ...
                                                <input type="checkbox"
                                                       x-model="selectedValues[<?php echo e($attr->id); ?>]"
                                                       value="<?php echo e($val->id); ?>::<?php echo e($val->value); ?>"
                                                       class="sr-only">
                                                <span><?php echo e($val->value); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/products/create.blade.php ENDPATH**/ ?>