...
<?php $__env->startSection('content'); ?>
    <div class="pb-20" x-data="quotationForm(<?php echo \Illuminate\Support\Js::from($units ?? [])->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($companyState ?? '')->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($clients ?? [])->toHtml() ?>)">
        ...
        <form id="mainQuotationForm" action="<?php echo e(route('admin.quotations.store')); ?>" method="POST"
            @submit="BizAlert.loading('Generating Quotation...')">
            <?php echo csrf_field(); ?>
            ...
            return {
                ...
                formData: {
                    ...
                    valid_until: new Date(new Date().setDate(new Date().getDate() + 15)).toISOString().split('T')[
                        0], // Auto +15 Days
                    store_id: "<?php echo e(session('store_id', auth()->user()->store_id ?? '')); ?>",
                    // 🌟 2. Use old() so we don't overwrite validation errors
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/quotations/create.blade.php ENDPATH**/ ?>