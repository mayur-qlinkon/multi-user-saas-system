                ...
                <div class="p-4 hover:bg-gray-50/50 transition-colors flex flex-col gap-3">
                    ...
                    <div class="flex justify-between items-start gap-2">
                        <div class="min-w-0 flex-1">
                            <p class="text-[14px] font-bold text-gray-900 leading-tight truncate"><?php echo e($empName); ?></p>
                        ...
                        <div class="text-right shrink-0 flex flex-col items-end">
                            <span class="font-black text-green-700 text-[16px]">₹<?php echo e(number_format($slip->net_salary, 2)); ?></span>
                            <span class="text-[10px] text-gray-400 font-bold uppercase tracking-wider mt-0.5"><?php echo e($months[$slip->month] ?? $slip->month); ?> <?php echo e($slip->year); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between bg-gray-50/80 px-3 py-2.5 rounded-lg border border-gray-100">
                        <div>
                            ...
                            <p class="text-[12px] font-bold text-gray-700">₹<?php echo e(number_format($slip->gross_salary, 2)); ?></p>
                        </div>
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-[12px] font-bold text-red-600">₹<?php echo e(number_format($slip->total_deductions, 2)); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-1 border-t border-gray-50 mt-1">
                        ...
                        <div class="flex items-center justify-end gap-2">
                            <?php if(has_permission('salary_slips.view')): ?>
                                <a href="<?php echo e(route('admin.hrm.salary-slips.show', $slip)); ?>" class="w-8 h-8 rounded-lg flex items-center justify-center border border-blue-200 bg-blue-50 text-blue-600 hover:bg-blue-100 transition-colors" title="View">
                                    <i data-lucide="eye" class="w-4 h-4"></i>
                                </a>
                            <?php endif; ?>

                            <?php if($slip->status === 'generated' && has_permission('salary_slips.approve')): ?>
                                <button @click="approveSlip(<?php echo e($slip->id); ?>)" class="w-8 h-8 rounded-lg flex items-center justify-center border border-amber-200 bg-amber-50 text-amber-600 hover:bg-amber-100 transition-colors" title="Approve">
                                    <i data-lucide="check-circle" class="w-4 h-4"></i>
                                </button>
                            <?php endif; ?>

                            <?php if($slip->status === 'approved' && has_permission('salary_slips.mark_paid')): ?>
                                <button @click="openPayModal(<?php echo e($slip->id); ?>)" class="w-8 h-8 rounded-lg flex items-center justify-center border border-green-200 bg-green-50 text-green-600 hover:bg-green-100 transition-colors" title="Mark Paid">
                                    <i data-lucide="banknote" class="w-4 h-4"></i>
                                </button>
                            <?php endif; ?>

                            <?php if(has_permission('salary_slips.download_pdf')): ?>
                                <a href="<?php echo e(route('admin.hrm.salary-slips.pdf', $slip)); ?>" target="_blank" class="w-8 h-8 rounded-lg flex items-center justify-center border border-indigo-200 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 transition-colors" title="Download PDF">
                                    <i data-lucide="download" class="w-4 h-4"></i>
                                </a>
                            <?php endif; ?>

                            <?php if($slip->status !== 'paid' && has_permission('salary_slips.delete')): ?>
                                <button @click="deleteSlip(<?php echo e($slip->id); ?>, $el.closest('.p-4'))" class="w-8 h-8 rounded-lg flex items-center justify-center border border-red-200 bg-red-50 text-red-500 hover:bg-red-100 transition-colors" title="Delete">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/hrm/salary-slips/index.blade.php ENDPATH**/ ?>