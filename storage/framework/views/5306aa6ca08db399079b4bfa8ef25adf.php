                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        <td class="px-5 py-3.5">
                            <div class="flex items-center gap-2">
                                ...
                                <?php if(!empty($leave->document)): ?>
                                    <a href="<?php echo e(asset('storage/' . $leave->document)); ?>" target="_blank" class="text-blue-500 hover:text-blue-700 transition-colors" title="View Document">
                        ...
                        <td class="px-5 py-3.5">
                            <div class="flex items-center gap-1">
                                ...
                                <button @click="openEdit(<?php echo e($leave->id); ?>, <?php echo e($leave->leave_type_id); ?>, '<?php echo e($leave->from_date->format('Y-m-d')); ?>', '<?php echo e($leave->to_date->format('Y-m-d')); ?>', <?php echo e($leave->total_days); ?>, '<?php echo e($leave->day_type); ?>', '<?php echo e(addslashes($leave->reason)); ?>', '<?php echo e($leave->document ? asset('storage/' . $leave->document) : ''); ?>')"
                ...
                <div class="p-4 hover:bg-gray-50/50 transition-colors">
                    ...
                    <div class="flex justify-between items-start mb-3">
                        <div>
                            ...
                            <p class="text-[11px] text-gray-400 mt-0.5 capitalize"><?php echo e(str_replace('_', ' ', $leave->day_type)); ?> • <span class="font-bold text-gray-600"><?php echo e($leave->total_days); ?> Day(s)</span></p>
                        </div>
                    ...
                    <div class="flex items-center justify-between pt-3 mt-3 border-t border-gray-50">
                        <span class="text-[11px] text-gray-400 font-medium">Applied: <?php echo e($leave->created_at->format('d M Y')); ?></span>
                ...
                <div class="p-5 space-y-4">
                    <div>
                        ...
                        <select x-model="form.leave_type_id" @change="checkDocumentRequirement($event)" class="field-input">
                            ...
                            <?php $__currentLoopData = $leaveTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($lt->id); ?>" data-requires-document="<?php echo e($lt->requires_document ? '1' : '0'); ?>"><?php echo e($lt->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/hrm/my-leaves/index.blade.php ENDPATH**/ ?>