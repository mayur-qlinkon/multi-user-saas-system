<?php $__env->startSection('title', get_setting('seo_title', 'Home')); ?>
                ...
                <div class="swiper-wrapper">
                    <?php $__empty_1 = true; $__currentLoopData = $heroBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="swiper-slide relative bg-gray-100 aspect-[16/9] md:aspect-[21/9] w-full overflow-hidden cursor-pointer"
                             <?php if($banner->link): ?> onclick="window.open('<?php echo e($banner->link); ?>', '<?php echo e($banner->target === '_blank' ? '_blank' : '_self'); ?>')" <?php endif; ?>>
                            ...
                            <div class="banner-content-wrapper">
                                <?php if(!empty($banner->title)): ?>
                                    <h2 class="banner-title"><?php echo nl2br(e($banner->title)); ?></h2>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.storefront', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/storefront/index.blade.php ENDPATH**/ ?>