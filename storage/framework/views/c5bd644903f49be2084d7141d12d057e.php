            ...
            <?php $__empty_1 = true; $__currentLoopData = $attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="p-4 hover:bg-gray-50/50 transition-colors">
                    ...
                    <div class="flex justify-between items-start mb-3">
                        <div>
                            <p class="text-[13px] font-bold text-gray-800"><?php echo e($att->date->format('d M Y')); ?></p>
                            <p class="text-[11px] text-gray-400 mt-0.5"><?php echo e($att->date->format('l')); ?></p>
                        </div>
                    ...
                    <div class="flex items-center justify-between bg-gray-50/80 px-3 py-2.5 rounded-lg border border-gray-100 mb-3">
                        <div>
                            ...
                            <p class="text-[12px] font-bold text-gray-700"><?php echo e($att->check_in_time ? $att->check_in_time->format('h:i A') : '—'); ?></p>
                        </div>
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-[12px] font-bold text-gray-700"><?php echo e($att->check_out_time ? $att->check_out_time->format('h:i A') : '—'); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between text-[11px] pt-1">
                        <div class="flex items-center gap-3">
                            <div>
                                ...
                                <span class="font-bold text-gray-700 ml-0.5"><?php echo e($att->worked_hours ? number_format($att->worked_hours, 1) . ' hrs' : '—'); ?></span>
                            </div>
                            <?php if($att->overtime_hours > 0): ?>
                            <div>
                                <span class="text-gray-400 font-medium">OT:</span>
                                <span class="font-black text-[#108c2a] ml-0.5"><?php echo e(number_format($att->overtime_hours, 1)); ?> hrs</span>
                            </div>
                            <?php endif; ?>
                        </div>
                        <span class="text-gray-400 capitalize font-medium flex items-center gap-1">
                            <i data-lucide="smartphone" class="w-3 h-3"></i> <?php echo e($att->check_in_method ?? '—'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/hrm/my-attendance/index.blade.php ENDPATH**/ ?>