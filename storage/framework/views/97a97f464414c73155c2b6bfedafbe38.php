            ...
            <table class="w-full">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $desig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="table-row" x-show="matchesSearch('<?php echo e(strtolower($desig->name)); ?>')">
                            <td class="px-5 py-3 text-[12px] font-bold text-gray-400"><?php echo e($designations->firstItem() + $loop->index); ?></td>
                            <td class="px-5 py-3">
