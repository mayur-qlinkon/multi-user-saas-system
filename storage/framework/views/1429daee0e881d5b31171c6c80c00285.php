...
<?php $__env->startSection('header-title'); ?>
    <div class="flex items-center gap-3">
        <a href="<?php echo e(route('admin.hrm.employees.show', $employee)); ?>"
        ...
        <div>
            ...
            <p class="text-xs text-gray-400 font-medium mt-0.5">Update employee record for <?php echo e($employee->user->name); ?></p>
        </div>
    </div>
...
<div class="pb-10" x-data="{ status: '<?php echo e(old('status', $employee->status)); ?>' }">

    <form method="POST" action="<?php echo e(route('admin.hrm.employees.update', $employee)); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div class="section-body">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-4">
                    ...
                    <div>
                        ...
                        <div class="field-readonly"><?php echo e($employee->employee_code); ?></div>
                    </div>

                    
                    <div>
                        <label class="field-label">Date of Joining <span class="text-red-500">*</span></label>
                        <input type="date" name="date_of_joining" value="<?php echo e(old('date_of_joining', $employee->date_of_joining?->format('Y-m-d'))); ?>"
                    ...
                    <div>
                        ...
                        <select name="department_id" class="field-input <?php echo e($errors->has('department_id') ? 'has-error' : ''); ?>">
                            ...
                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($department->id); ?>" <?php echo e(old('department_id', $employee->department_id) == $department->id ? 'selected' : ''); ?>><?php echo e($department->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div>
                        ...
                        <select name="designation_id" class="field-input <?php echo e($errors->has('designation_id') ? 'has-error' : ''); ?>">
                            ...
                            <?php $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $designation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($designation->id); ?>" <?php echo e(old('designation_id', $employee->designation_id) == $designation->id ? 'selected' : ''); ?>><?php echo e($designation->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="shift_id" class="field-input <?php echo e($errors->has('shift_id') ? 'has-error' : ''); ?>">
                            <option value="">Select shift</option>
                            <?php $__currentLoopData = $shifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($shift->id); ?>" <?php echo e(old('shift_id', $employee->shift_id) == $shift->id ? 'selected' : ''); ?>><?php echo e($shift->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="reporting_to" class="field-input <?php echo e($errors->has('reporting_to') ? 'has-error' : ''); ?>">
                            <option value="">Select manager</option>
                            <?php $__currentLoopData = $managers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manager): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($manager->id); ?>" <?php echo e(old('reporting_to', $employee->reporting_to) == $manager->id ? 'selected' : ''); ?>><?php echo e($manager->employee_code); ?> - <?php echo e($manager->user->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="status" x-model="status" class="field-input <?php echo e($errors->has('status') ? 'has-error' : ''); ?>">
                            <?php $__currentLoopData = ['active' => 'Active', 'inactive' => 'Inactive', 'terminated' => 'Terminated', 'on_notice' => 'On Notice', 'absconding' => 'Absconding']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val); ?>" <?php echo e(old('status', $employee->status) == $val ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div x-show="status === 'terminated' || status === 'absconding'" x-cloak class="mt-4">
                    ...
                    <textarea name="exit_reason" rows="3"
                        ...
                        class="field-input resize-none <?php echo e($errors->has('exit_reason') ? 'has-error' : ''); ?>"><?php echo e(old('exit_reason', $employee->exit_reason)); ?></textarea>
                    <?php $__errorArgs = ['exit_reason'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div>
                        ...
                        <select name="gender" class="field-input <?php echo e($errors->has('gender') ? 'has-error' : ''); ?>">
                            ...
                            <?php $__currentLoopData = ['male' => 'Male', 'female' => 'Female', 'other' => 'Other']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val); ?>" <?php echo e(old('gender', $employee->gender) == $val ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div>
                        ...
                        <select name="marital_status" class="field-input <?php echo e($errors->has('marital_status') ? 'has-error' : ''); ?>">
                            ...
                            <?php $__currentLoopData = ['single' => 'Single', 'married' => 'Married', 'divorced' => 'Divorced', 'widowed' => 'Widowed']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val); ?>" <?php echo e(old('marital_status', $employee->marital_status) == $val ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="blood_group" value="<?php echo e(old('blood_group', $employee->blood_group)); ?>"
            ...
            <div class="section-body">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="basic_salary" value="<?php echo e(old('basic_salary', $employee->basic_salary)); ?>"
                    ...
                    <div>
                        ...
                        <select name="salary_type" class="field-input <?php echo e($errors->has('salary_type') ? 'has-error' : ''); ?>">
                            ...
                            <?php $__currentLoopData = ['monthly' => 'Monthly', 'daily' => 'Daily', 'hourly' => 'Hourly']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($val); ?>" <?php echo e(old('salary_type', $employee->salary_type) == $val ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_account_number" value="<?php echo e(old('bank_account_number', $employee->bank_account_number)); ?>"
                            placeholder="Account number"
                            class="field-input <?php echo e($errors->has('bank_account_number') ? 'has-error' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_ifsc" value="<?php echo e(old('bank_ifsc', $employee->bank_ifsc)); ?>"
                            placeholder="IFSC code"
                            class="field-input <?php echo e($errors->has('bank_ifsc') ? 'has-error' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_branch" value="<?php echo e(old('bank_branch', $employee->bank_branch)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="aadhaar_number" value="<?php echo e(old('aadhaar_number', $employee->aadhaar_number)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="uan_number" value="<?php echo e(old('uan_number', $employee->uan_number)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="esi_number" value="<?php echo e(old('esi_number', $employee->esi_number)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="pf_number" value="<?php echo e(old('pf_number', $employee->pf_number)); ?>"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="current_address" rows="3"
                            ...
                            class="field-input resize-none <?php echo e($errors->has('current_address') ? 'has-error' : ''); ?>"><?php echo e(old('current_address', $employee->current_address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="permanent_address" rows="3"
                            ...
                            class="field-input resize-none <?php echo e($errors->has('permanent_address') ? 'has-error' : ''); ?>"><?php echo e(old('permanent_address', $employee->permanent_address)); ?></textarea>
            ...
            <div class="section-body">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="emergency_contact_name" value="<?php echo e(old('emergency_contact_name', $employee->emergency_contact_name)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="emergency_contact_phone" value="<?php echo e(old('emergency_contact_phone', $employee->emergency_contact_phone)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="emergency_contact_relation" value="<?php echo e(old('emergency_contact_relation', $employee->emergency_contact_relation)); ?>"
        ...
        <div class="form-section">
            ...
            <div class="section-body">
                <textarea name="notes" rows="3"
                    ...
                    class="field-input resize-none w-full <?php echo e($errors->has('notes') ? 'has-error' : ''); ?>"><?php echo e(old('notes', $employee->notes)); ?></textarea>
                    ...
                    <div>
                        ...
                        <?php if($employee->photo): ?>
                            <div class="mb-2 flex items-center gap-3">
                                <img src="<?php echo e(Storage::url($employee->photo)); ?>" alt="Photo" class="w-10 h-10 rounded-full object-cover border border-gray-200">
                                <span class="text-[10px] text-gray-500 font-medium">Upload new to replace</span>
                            </div>
                        <?php endif; ?>
                        <input type="file" name="photo" accept="image/*" class="field-input <?php echo e($errors->has('photo') ? 'has-error' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <?php if($employee->id_proof): ?>
                            <div class="mb-2">
                                <a href="<?php echo e(Storage::url($employee->id_proof)); ?>" target="_blank" class="text-xs font-bold text-blue-600 hover:underline flex items-center gap-1">
                                    <i data-lucide="external-link" class="w-3 h-3"></i> View Current Document
                                </a>
                            </div>
                        <?php endif; ?>
                        <input type="file" name="id_proof" accept=".pdf,image/*" class="field-input <?php echo e($errors->has('id_proof') ? 'has-error' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <?php if($employee->address_proof): ?>
                            <div class="mb-2">
                                <a href="<?php echo e(Storage::url($employee->address_proof)); ?>" target="_blank" class="text-xs font-bold text-blue-600 hover:underline flex items-center gap-1">
                                    <i data-lucide="external-link" class="w-3 h-3"></i> View Current Document
                                </a>
                            </div>
                        <?php endif; ?>
                        <input type="file" name="address_proof" accept=".pdf,image/*" class="field-input <?php echo e($errors->has('address_proof') ? 'has-error' : ''); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/hrm/employees/edit.blade.php ENDPATH**/ ?>