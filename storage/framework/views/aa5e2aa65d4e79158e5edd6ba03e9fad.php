                ...
                <div class="w-full md:w-auto text-left md:text-right print:text-right text-sm flex flex-col items-start md:items-end print:items-end">
                    ...
                    <?php if($store): ?>
                        <div class="mt-4 text-left md:text-right print:text-right">
                            <h3 class="text-[10px] font-black text-gray-700 uppercase tracking-widest">Branch: <span class="font-bold text-black"><?php echo e($store->name); ?></span></h3>
            ...
            <div class="p-5 sm:p-8 grid grid-cols-1 md:grid-cols-2 print:grid-cols-2 gap-6 sm:gap-8 border-b border-gray-200">
                    ...
                    <div>
                        ...
                        <div class="text-sm text-gray-800">
                            ...
                            <?php if($customerAddress !== 'N/A'): ?>
                                <div class="text-gray-600 leading-tight mt-1"><?php echo e($customerAddress); ?></div>
                            <?php endif; ?>
                            <?php if($customerPhone !== 'N/A'): ?>
                                <div class="text-gray-600 mt-1">Phone: <?php echo e($customerPhone); ?></div>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-1 bg-gray-50 md:bg-transparent print:bg-transparent p-4 md:p-0 rounded-lg md:rounded-none border md:border-none border-gray-100">
                    <div class="grid grid-cols-2 text-[13px]">
                        ...
                        <span class="text-right font-semibold"><?php echo e(\Carbon\Carbon::parse($invoice->invoice_date)->format('d M Y')); ?></span>
                    </div>
                    <?php if($invoice->due_date): ?>
                        <div class="grid grid-cols-2 text-[13px]">
                            <span class="font-bold text-gray-500">Due Date:</span>
                            <span class="text-right font-semibold"><?php echo e(\Carbon\Carbon::parse($invoice->due_date)->format('d M Y')); ?></span>
                        </div>
                    <?php endif; ?>
                    <div class="grid grid-cols-2 text-[13px]">
                        <span class="font-bold text-gray-500">Place of Supply:</span>
                        <span class="text-right font-bold text-gray-900"><?php echo e($invoice->supply_state); ?> (<?php echo e($stateCode); ?>)</span>
                    </div>
                    <div class="grid grid-cols-2 text-[13px]">
                    ...
                    <div class="grid grid-cols-2 text-[13px] pt-2 mt-1 border-t border-gray-200 md:border-gray-100">
                        ...
                        <span class="text-right font-black uppercase <?php echo e($invoice->payment_status === 'paid' ? 'text-green-600' : 'text-red-500'); ?>">
                            ...
                            <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="py-4 px-2">
                                        ...
                                        <?php if(batch_enabled() && isset($batchMovements[$item->product_sku_id])): ?>
            ...
            <div class="px-5 sm:px-8 pb-8 page-break-avoid flex flex-col md:flex-row print:flex-row justify-between items-start md:items-end print:items-end gap-8 print:gap-4">
                ...
                <div class="w-full md:w-1/2 print:w-1/2 mb-6 md:mb-0 print:mb-0 space-y-6">
                    ...
                    <div class="flex flex-wrap items-start gap-8 pt-4 border-t border-gray-100">
                        ...
                        <?php if($balanceDue > 0 && $billingUpiId): ?>
                            <div>
                                    ...
                                    <tr>
                                        <td class="py-2 text-gray-600 font-medium">
                                            ...
                                            <?php if($invoice->discount_type === 'percentage'): ?>
                                                <span class="text-xs text-gray-500 ml-1">(<?php echo e((float) $invoice->discount_value); ?>%)</span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="py-2 text-right font-bold text-red-600">(-) ₹<?php echo e($formatAmt($invoice->discount_amount)); ?></td>
                                    </tr>
                                <?php endif; ?>
