...
<?php $__env->startSection('header-title'); ?>
    <div>
        <h1 class="text-[17px] font-bold text-gray-800 leading-none">Merchandising</h1>
...
<?php $__env->startSection('content'); ?>
    <div class="pb-4" x-data="merchandising()">
        ...
        <div class="mb-4 flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-[#212538] tracking-tight">Merchandising</h1>
            ...
            <div class="panel">
                <div class="panel-header">
                    <p class="text-[11px] font-black text-gray-400 uppercase tracking-widest mb-2">
                        Categories <span class="text-gray-300">(<?php echo e($categories->count()); ?>)</span>
                    </p>
                ...
                <div class="panel-body">
                    <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <button type="button"
                            class="cat-item w-full text-left <?php echo e($selectedCategory?->id === $cat->id ? 'active' : ''); ?>"
                            x-show="!catSearch || '<?php echo e(strtolower($cat->name)); ?>'.includes(catSearch.toLowerCase())"
                            @click="selectCategory(<?php echo e($cat->id); ?>, '<?php echo e(addslashes($cat->name)); ?>')"
                            :class="{ 'active': activeCategoryId === <?php echo e($cat->id); ?> }"
                            id="cat-item-<?php echo e($cat->id); ?>">

                            
                            <?php if($cat->image): ?>
                                <img src="<?php echo e(asset('storage/' . $cat->image)); ?>" alt="<?php echo e($cat->name); ?>" class="cat-thumb"
                            ...
                            <span class="cat-badge"><?php echo e($cat->total_products ?? 0); ?></span>
                        </button>
                                ...
                                <template x-for="(prod, index) in products" :key="prod.product_id ?? prod.product?.id">
                                    <div class="product-row" :data-product-id="prod.product_id ?? prod.product?.id"
                                        ...
                                        <img :src="prod.product?.primary_image_url ?? prod.image_url ??
                                            '<?php echo e(asset('assets/images/no-product.png')); ?>'"
                                            class="prod-thumb"
                                            onerror="this.src='<?php echo e(asset('assets/images/no-product.png')); ?>'">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        function merchandising() {
            return {
                // ── State ──
                activeCategoryId: <?php echo e($selectedCategory?->id ?? 'null'); ?>,
                activeCategoryName: '<?php echo e(addslashes($selectedCategory?->name ?? '')); ?>',
                products: <?php echo json_encode($assignedProducts ?? [], 15, 512) ?>,
                productCount: <?php echo e($assignedProducts?->count() ?? 0); ?>,
                isLoading: false,
                catSearch: '',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/merchandising/index.blade.php ENDPATH**/ ?>