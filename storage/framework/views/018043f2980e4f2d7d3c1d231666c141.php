...
<?php $__env->startSection('title', 'Edit Plan - Qlinkon'); ?>
<?php $__env->startSection('header', 'Edit Subscription Plan'); ?>
    ...
    <div class="w-full pb-10" x-data="planFormManager(<?php echo \Illuminate\Support\Js::from($modules->pluck('id'))->toHtml() ?>)">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <h1 class="text-2xl font-bold text-gray-800 tracking-tight">Edit "<?php echo e($plan->name); ?>"</h1>
            </div>
        </div>
        ...
        <form action="<?php echo e(route('platform.plans.update', $plan->id)); ?>" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name', $plan->name)); ?>" required class="form-input">
                        </div>
                        <div class="md:col-span-2">
                            <label class="form-label">Short Description</label>
                            <input type="text" name="description" value="<?php echo e(old('description', $plan->description)); ?>" class="form-input">
                        </div>
                        
                        <div>
                            <label class="form-label">Price (₹) <span class="text-red-500">*</span></label>
                            <input type="number" step="0.01" name="price" value="<?php echo e(old('price', $plan->price)); ?>" required class="form-input">
                        </div>
                        <div>
                            ...
                            <select name="billing_cycle" required class="form-input bg-white">
                                ...
                                <option value="lifetime" <?php echo e(old('billing_cycle', $plan->billing_cycle) == 'lifetime' ? 'selected' : ''); ?>>Lifetime (One-time)</option>
                            </select>
                        </div>
                        <div>
                            <label class="form-label">Free Trial Days</label>
                            <input type="number" name="trial_days" value="<?php echo e(old('trial_days', $plan->trial_days)); ?>" min="0" class="form-input">
                        </div>
                        <div class="mt-2 md:mt-8">
                            <label class="flex items-center gap-2 cursor-pointer w-max">
                                <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $plan->is_active) ? 'checked' : ''); ?> class="w-4 h-4 text-brand-600 rounded border-gray-300 focus:ring-brand-500">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="number" name="user_limit" value="<?php echo e(old('user_limit', $plan->user_limit)); ?>" required min="1" class="form-input">
                        </div>
                        <div>
                            <label class="form-label">Store Limit <span class="text-red-500">*</span></label>
                            <input type="number" name="store_limit" value="<?php echo e(old('store_limit', $plan->store_limit)); ?>" required min="1" class="form-input">
                        </div>
                        <div>
                            <label class="form-label">Product Limit <span class="text-red-500">*</span></label>
                            <input type="number" name="product_limit" value="<?php echo e(old('product_limit', $plan->product_limit)); ?>" required min="1" class="form-input">
                        </div>
                        <div>
                            <label class="form-label">Employee Limit <span class="text-red-500">*</span></label>
                            <input type="number" name="employee_limit" value="<?php echo e(old('employee_limit', $plan->employee_limit)); ?>" required min="1" class="form-input">
                        </div>
                        <div>
                            <label class="form-label">Daily OCR Scans <span class="text-red-500">*</span></label>
                            <input type="number" name="ocr_scan_limit" value="<?php echo e(old('ocr_scan_limit', $plan->ocr_scan_limit)); ?>" required min="0" class="form-input">
                        </div>
                    </div>
                </div>
    ...
    <script>
        function planFormManager(allModuleIds) {
            return {
                ...
                selectedModules: <?php echo json_encode(old('modules', $plan->modules->pluck('id')->toArray()), 512) ?>,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.platform', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/platform/plans/edit.blade.php ENDPATH**/ ?>