                                        ...
                                        <div class="flex items-center gap-3 sm:gap-4 flex-shrink-0">
                                            ...
                                            <button type="button"
                                                ...
                                                <span class="hidden sm:inline text-[11px] font-black uppercase tracking-wider" 
                                                      x-text="speakingKey === <?php echo e($loop->index); ?> ? 'Stop' : 'Listen'">
                                                </span>
                                            </button>
                            ...
                            <?php $__currentLoopData = $related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <a href="<?php echo e(route('storefront.product', ['slug' => $company->slug, 'productSlug' => $rel->slug])); ?>"
                                    ...
                                    <div class="p-3">
                                        ...
                                        <p class="text-[14px] font-bold text-gray-900">₹<?php echo e(number_format($relPrice, 2)); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.storefront', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/public/product.blade.php ENDPATH**/ ?>