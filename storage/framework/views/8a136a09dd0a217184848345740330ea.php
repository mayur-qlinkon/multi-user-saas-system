...
<head>
    ...
    <meta name="company-slug" content="<?php echo e(request()->route('slug') ?? ''); ?>">
   ...
   <?php
    ...
    <title><?php echo $__env->yieldContent('title', get_setting('seo_title', 'Qlinkon Shop')); ?></title>
    <?php echo $__env->yieldContent('meta'); ?>

    <?php if(get_setting('favicon')): ?>
        <link rel="icon" type="image/png" href="<?php echo e(asset('storage/' . get_setting('favicon'))); ?>">
    <?php endif; ?>
    ...
    <script defer src="https://cdn.jsdelivr.net/npm/@alpinejs/intersect@3.x.x/dist/cdn.min.js"></script>
        ...
        <script defer src="<?php echo e(asset('assets/js/sweetalert2.js')); ?>"></script>
...
<body class="antialiased font-sans flex flex-col min-h-screen" x-data="{
    ...
    form: <?php echo \Illuminate\Support\Js::from($autoFill)->toHtml() ?>,
    formErrors: {},
    isSubmitting: false,
    orderResult: {},
    ...
    <header class="bg-white border-b border-gray-100 sticky top-0 z-40 shadow-sm">
        <div
            ...
            <a href="/<?php echo e($companySlug); ?>" class="flex items-center gap-2.5 shrink-0">
                <?php if(get_setting('icon')): ?>
                    <img src="<?php echo e(asset('storage/' . get_setting('icon'))); ?>" alt="Store Logo" class="h-10 object-contain">
                <?php else: ?>
                    ...
                    <span class="font-bold text-[18px] sm:text-[22px] text-gray-800 tracking-tight">
                        <?php echo e($company->name ?? 'StoreFront'); ?>
                            ...
                            <template x-for="product in results" :key="product.slug">
                                <a :href="'/' + companySlug + '/product/' + product.slug"
                                    ...
                                    <img :src="product.image"
                                        ...
                                        onerror="this.onerror=null; this.src='<?php echo e(asset('assets/images/no-product.webp')); ?>';">
            ...
            <div class="flex items-center gap-4 shrink-0 text-gray-600">
                ...
                <a href="<?php echo e($accountUrl); ?>" class="hover:text-gray-900 transition-colors sm:block">
                                        ...
                                        <div class="bg-gray-50 rounded-2xl p-4 mb-5 space-y-3">
                                            <div class="flex items-center justify-between">
                                                <span
                                                    ...
                                                    Number</span>
                                                   <a :href="`<?php echo e(url($companySlug.'/orders')); ?>/${orderResult.order_number}`">
    ...
    <footer class="bg-[#f8f9fa] border-t border-gray-200 pt-16 pb-8 mt-auto">
        <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
               <div>
                    <div class="mb-5">
                        <h4 class="text-[16px] font-black text-gray-900 tracking-tight"><?php echo e($company->name ?? config('app.name')); ?></h4>
                        <?php if(get_setting('storefront_tagline')): ?>
                            <p class="text-[12px] text-gray-500 font-medium mt-1 leading-relaxed"><?php echo e(get_setting('storefront_tagline')); ?></p>
                        <?php endif; ?>
                    </div>
                    <ul class="space-y-4 text-[13px] text-gray-500 font-medium">
                        ...
                        <?php if(get_setting('business_hours')): ?>
                            <li class="flex items-start gap-3 pt-2">
                                <i data-lucide="clock" class="w-4 h-4 shrink-0 mt-0.5 text-gray-400"></i>
                                <span class="leading-relaxed whitespace-pre-line"><?php echo e(get_setting('business_hours')); ?></span>
                            </li>
                        <?php endif; ?>
                    </ul>
                    ...
                    <div class="flex items-center gap-3 mt-6">
                        <?php if(get_setting('whatsapp')): ?>
                            <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', get_setting('whatsapp'))); ?>" target="_blank"
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-[13px] text-gray-500 font-medium">
                        <li><a href="<?php echo e(route('storefront.portal.dashboard', ['slug' => $companySlug])); ?>" class="hover:text-brand-500 transition-colors">Dashboard</a></li>
                        <li><a href="<?php echo e(route('storefront.portal.orders', ['slug' => $companySlug])); ?>" class="hover:text-brand-500 transition-colors">My Orders</a></li>
                        <li><a href="<?php echo e(route('storefront.portal.profile', ['slug' => $companySlug])); ?>" class="hover:text-brand-500 transition-colors">My Profile</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-[13px] text-gray-500 font-medium">
                        <li><a href="<?php echo e(route('storefront.page.show', [$company->slug, 'return-policy'])); ?>" class="hover:text-brand-500 transition-colors">Return Policy</a></li>
                        <li><a href="<?php echo e(route('storefront.page.show', [$company->slug, 'faq'])); ?>" class="hover:text-brand-500 transition-colors">FAQ</a></li>
                        <li><a href="<?php echo e(route('storefront.page.show', [$company->slug, 'privacy-policy'])); ?>" class="hover:text-brand-500 transition-colors">Privacy & Policy</a></li>
                        <li><a href="<?php echo e(route('storefront.page.show', [$company->slug, 'terms-and-conditions'])); ?>" class="hover:text-brand-500 transition-colors">Terms & Conditions</a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-[13px] text-gray-500 font-medium">
                        <li>
                            <a href="<?php echo e(route('storefront.page.show', [$company->slug, 'about-us'])); ?>" 
                        ...
                        <li>
                            <a href="<?php echo e(route('storefront.page.show', [$company->slug, 'contact-us'])); ?>" 
                            class="hover:text-brand-500 transition-colors">
                            Contact Us
                            </a>
                        </li>
            ...
            <div class="pt-6 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between gap-4">
                <p class="text-[12px] text-gray-500 font-medium tracking-wide">
                    ...
                    <span class="font-bold"
                        style="color: var(--brand-600);"><?php echo e($company->name ?? config('app.name')); ?></span>
                </p>
    ...
    <?php if(get_setting('whatsapp')): ?>
        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', get_setting('whatsapp'))); ?>?text=<?php echo e(urlencode("Hi, I'm interested in your products")); ?>"
            target="_blank"
...
<?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas\resources\views/layouts/storefront.blade.php ENDPATH**/ ?>