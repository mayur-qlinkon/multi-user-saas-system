            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <?php $__currentLoopData = ['today' => 'Today', 'week' => 'This Week', 'month' => 'This Month', 'year' => 'This Year']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button type="button" @click="exportPeriod = '<?php echo e($val); ?>'"
                                :class="exportPeriod === '<?php echo e($val); ?>'
                                    ? 'border-2 font-black text-white'
                                    : 'border border-gray-200 font-bold text-gray-600 hover:border-gray-300 bg-white'"
                                :style="exportPeriod === '<?php echo e($val); ?>' ? 'border-color: var(--brand-600); background: var(--brand-600)' : ''"
...
window.attendanceReport = function() {
    return {
        ...
        triggerExport(type) {
            ...
            const base = type === 'pdf'
                ? '<?php echo e(route('admin.hrm.attendance.export.pdf')); ?>'
                : '<?php echo e(route('admin.hrm.attendance.export.excel')); ?>';
