...
<?php $__env->startSection('content'); ?>
    <div class="pb-10" x-data="bannerCreate()">
        ...
        <form id="banner-form" method="POST" action="<?php echo e(route('admin.banners.store')); ?>" enctype="multipart/form-data"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="alt_text" value="<?php echo e(old('alt_text')); ?>"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex flex-wrap gap-2 mt-1">
                                <?php $__currentLoopData = ['hero' => 'Hero Slider', 'category' => 'Category']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                    <label class="type-pill <?php echo e(old('type', 'hero') === $val ? 'selected' : ''); ?>"
                                        @click="selectType('<?php echo e($val); ?>')">
                                        <input type="radio" name="type" value="<?php echo e($val); ?>"
                                            <?php echo e(old('type', 'hero') === $val ? 'checked' : ''); ?> class="sr-only">
                                        <?php echo e($label); ?>
                        ...
                        <div>
                            ...
                            <select name="position" class="field-input <?php echo e($errors->has('position') ? 'error' : ''); ?>">
                                ...
                                <?php $__currentLoopData = [
                                    ...
                                    <option value="<?php echo e($val); ?>" <?php echo e(old('position') === $val ? 'selected' : ''); ?>>
                                        <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="button_text" value="<?php echo e(old('button_text')); ?>"
                            ...
                            <div>
                                ...
                                <select name="target" class="field-input">
                                    <option value="_self" <?php echo e(old('target', '_self') === '_self' ? 'selected' : ''); ?>>
                                        Same Tab (_self)
                                    </option>
                                    <option value="_blank" <?php echo e(old('target') === '_blank' ? 'selected' : ''); ?>>
                                        New Tab (_blank)
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="toggle-row">
                                ...
                                <label class="toggle-switch">
                                    <input type="checkbox" name="is_active" value="1"
                                        <?php echo e(old('is_active', '1') === '1' ? 'checked' : ''); ?> x-model="isActive">
                        ...
                        <div x-show="open" x-cloak x-transition class="space-y-4 mt-2">
                            <div>
                                ...
                                <input type="color" name="meta[bg_color]"
                                    value="<?php echo e(old('meta.bg_color', '#ffffff')); ?>"
                            ...
                            <div>
                                ...
                                <input type="color" name="meta[text_color]"
                                    value="<?php echo e(old('meta.text_color', '#000000')); ?>"
                                    class="w-full h-10 rounded-xl border border-gray-200 cursor-pointer">
                            </div>
                            <div>
                                ...
                                <select name="meta[animation]" class="field-input">
                                    <option value="none"
                                        <?php echo e(old('meta.animation', 'none') === 'none' ? 'selected' : ''); ?>>None</option>
                                    <option value="fade" <?php echo e(old('meta.animation') === 'fade' ? 'selected' : ''); ?>>Fade
                                    </option>
                                    <option value="slide" <?php echo e(old('meta.animation') === 'slide' ? 'selected' : ''); ?>>
                                        Slide</option>
                                    <option value="zoom" <?php echo e(old('meta.animation') === 'zoom' ? 'selected' : ''); ?>>Zoom
                                    </option>
                                </select>
                            </div>
                        </div>
        ...
        function bannerCreate() {
            return {
                ...
                init() {
                    ...
                    <?php if(old('type')): ?>
                        this.selectType('<?php echo e(old('type')); ?>');
                    <?php endif; ?>
                }
            }
        }
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/banners/create.blade.php ENDPATH**/ ?>