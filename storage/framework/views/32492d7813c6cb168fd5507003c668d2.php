<?php $__env->startSection('title', 'Manage Permissions - Qlinkon Super Admin'); ?>
<?php $__env->startSection('header', 'System Permissions'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="pb-10" x-data="permissionManager(<?php echo \Illuminate\Support\Js::from($permissions)->toHtml() ?>)">
        ...
        <div class="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <form action="<?php echo e(route('platform.permissions.sync')); ?>" method="POST" class="m-0">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
        ...
        <?php $__empty_1 = true; $__currentLoopData = $groupedPermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $groupPerms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="mb-8">
                <h2 class="text-sm font-black text-gray-400 uppercase tracking-widest mb-4 flex items-center gap-2">
                    ...
                    <?php echo e(Str::headline($groupName)); ?>

                    <span class="bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full text-[10px] ml-2"><?php echo e($groupPerms->count()); ?></span>
                </h2>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    <?php $__currentLoopData = $groupPerms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 flex flex-col hover:shadow-md transition-shadow relative group">
                            ...
                            <h3 class="text-[15px] font-bold text-gray-800 mb-1"><?php echo e($permission->name); ?></h3>
                            ...
                            <div class="mt-auto pt-4 border-t border-gray-100 flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button type="button" @click="openEdit(<?php echo e($permission->id); ?>)"
                                    class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors" title="Edit Permission">
                                    <i data-lucide="pencil" class="w-4 h-4"></i>
                                </button>
                                <button type="button" @click="openDelete(<?php echo e($permission->id); ?>, '<?php echo e(addslashes($permission->name)); ?>')"
        ...
        <div x-cloak x-show="showFormModal" class="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col"
                ...
                <form :action="isEditing ? `/platform/permissions/${form.id}` : '<?php echo e(route('platform.permissions.store')); ?>'" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <datalist id="module-groups">
                                <?php $__currentLoopData = $moduleGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($group); ?>"></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </datalist>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.platform', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/platform/permissions.blade.php ENDPATH**/ ?>