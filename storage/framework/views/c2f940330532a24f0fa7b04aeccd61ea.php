<?php $__env->startSection('title', 'Manage Subscriptions - Qlinkon Super Admin'); ?>
<?php $__env->startSection('header', 'Client Subscriptions'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="pb-10" x-data="subscriptionManager(<?php echo \Illuminate\Support\Js::from($subscriptions)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($companies)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($plans)->toHtml() ?>)">
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                <td class="px-6 py-4">
                                    <div class="font-bold text-gray-800 text-sm">
                                        <?php echo e($sub->company->name ?? 'Unknown Company'); ?></div>
                                </td>
                                <td class="px-6 py-4">
                                    <div
                                        ...
                                        <?php echo e($sub->plan->name ?? 'Unknown Plan'); ?>
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-xs text-gray-600 font-medium">
                                        <div class="mb-0.5"><span class="text-gray-400">Start:</span>
                                            <?php echo e($sub->starts_at ? \Carbon\Carbon::parse($sub->starts_at)->format('M d, Y') : 'Immediate'); ?>

                                        </div>
                                        <div><span class="text-gray-400">Exp:</span>
                                            <?php echo e($sub->expires_at ? \Carbon\Carbon::parse($sub->expires_at)->format('M d, Y') : 'Lifetime / Null'); ?>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <button type="button" @click="openModal(<?php echo e($sub->id); ?>)"
        ...
        <div x-cloak x-show="showModal" class="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col"
                ...
                <form action="<?php echo e(route('platform.subscriptions.assign')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.platform', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/platform/subscriptions.blade.php ENDPATH**/ ?>