...
<?php $__env->startSection('content'); ?>
    <div class="pb-10" x-data="clientManager(<?php echo \Illuminate\Support\Js::from($clients->items())->toHtml() ?>)">
        ...
        <div class="bg-white rounded-t-xl shadow-sm border border-gray-100 p-4 border-b-0">
            <form action="<?php echo e(route('admin.clients.index')); ?>" method="GET" class="flex flex-col sm:flex-row gap-3">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/clients.blade.php ENDPATH**/ ?>