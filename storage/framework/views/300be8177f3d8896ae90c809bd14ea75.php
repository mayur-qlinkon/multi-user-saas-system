<?php $__env->startSection('title', 'Log New Expense - Qlinkon BIZNESS'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="w-full px-4 py-6 sm:px-6 lg:px-8 xl:px-5" x-data="expenseForm()">
        ...
        <?php if($errors->any()): ?>
            <script>
                document.addEventListener('DOMContentLoaded', () => {
                    console.error('[ExpenseForm] Server validation errors:', <?php echo json_encode($errors->all(), 15, 512) ?>);
        ...
        <form action="<?php echo e(route('admin.expenses.store')); ?>" method="POST" enctype="multipart/form-data" @submit="submitForm($event)">
            <?php echo csrf_field(); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <select name="expense_category_id" required
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <optgroup label="<?php echo e($parent->name); ?>">
                                                <option value="<?php echo e($parent->id); ?>" <?php if(old('expense_category_id') == $parent->id): echo 'selected'; endif; ?>><?php echo e($parent->name); ?> (Main)</option>
                                                <?php $__currentLoopData = $parent->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($child->id); ?>" <?php if(old('expense_category_id') == $child->id): echo 'selected'; endif; ?>>&nbsp;&nbsp;&nbsp;↳ <?php echo e($child->name); ?></option>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="notes" rows="4"
                                        ...
                                        class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-700 focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 outline-none transition-all resize-y shadow-sm"><?php echo e(old('notes')); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-4 sm:p-6 lg:p-4 xl:p-6 space-y-6">
                            ...
                            <div class="pt-2 flex flex-col xl:flex-row gap-3">
                                ...
                                <button type="submit" :disabled="isSubmitting" class="flex-1 bg-[#108c2a] hover:bg-[#0c6b1f] text-white px-4 py-3 rounded-xl text-sm font-bold shadow-lg shadow-green-600/20 transition-all active:scale-95 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed whitespace-nowrap">
    ...
    <script>
        function expenseForm() {
            return {
                ...
                baseAmount: <?php echo e(old('base_amount', 0)); ?>,
                taxType: '<?php echo e(old('tax_type', 'none')); ?>',
                taxPercent: <?php echo e(old('tax_percent', 0)); ?>,
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/expenses/create.blade.php ENDPATH**/ ?>