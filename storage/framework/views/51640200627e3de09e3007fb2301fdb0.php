<?php $__env->startSection('title', 'Edit Lead — ' . $lead->name); ?>
...
<?php $__env->startSection('header-title'); ?>
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-xs text-gray-400 font-medium mt-0.5"><?php echo e($lead->name); ?></p>
        </div>
    </div>
            ...
            <div class="form-section">
                <div class="section-body">
                    <div class="flex items-center gap-3 mb-3 pb-3 border-b border-gray-50">
                        ...
                        <div class="min-w-0">
                            <p class="text-[13px] font-bold text-gray-900 truncate"><?php echo e($lead->name); ?></p>
                            <p class="text-[11px] text-gray-400">
                                Score: <strong><?php echo e($lead->score); ?></strong> ·
                    ...
                    <div class="flex items-center justify-between text-[12px]">
                        ...
                        <span class="font-semibold text-gray-600"><?php echo e($lead->created_at->format('d M Y')); ?></span>
                    </div>
            ...
            <div class="form-section">
                ...
                <div class="section-body">
                    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4 gap-2">
                        <?php $__currentLoopData = ['low' => 'Low', 'medium' => 'Medium', 'high' => 'High', 'hot' => '🔥 Hot']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button type="button"
                                @click="form.priority = '<?php echo e($val); ?>'"
                                class="priority-btn"
                                :class="form.priority === '<?php echo e($val); ?>' ? 'selected-<?php echo e($val); ?>' : ''">
                                <?php echo e($label); ?>
                        ...
                        <div class="flex flex-wrap gap-2">
                            <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button type="button"
                                    ...
                                    class="tag-chip"
                                    :class="form.tags.includes(<?php echo e($tag->id); ?>) ? 'selected' : ''"
                                    style="background: <?php echo e($tag->color); ?>18; color: <?php echo e($tag->color); ?>">
                                    <span class="w-1.5 h-1.5 rounded-full"
                                        style="background: <?php echo e($tag->color); ?>"></span>
                                    <?php echo e($tag->name); ?>
...
function editLeadPage() {
    return {
        ...
        originalStageId: <?php echo \Illuminate\Support\Js::from($currentStageId)->toHtml() ?>,
        stageChanged:    false,
        ...
        form: {
            ...
            phone:              '<?php echo e(addslashes($lead->phone ?? '')); ?>',
            email:              '<?php echo e(addslashes($lead->email ?? '')); ?>',
            company_name:       '<?php echo e(addslashes($lead->company_name ?? '')); ?>',
            lead_value:         '<?php echo e($lead->lead_value ?? ''); ?>',
            crm_pipeline_id:    <?php echo \Illuminate\Support\Js::from($currentPipelineId)->toHtml() ?>,
            crm_stage_id:       <?php echo \Illuminate\Support\Js::from($currentStageId)->toHtml() ?>,
            crm_lead_source_id: '<?php echo e($lead->crm_lead_source_id ?? ''); ?>',
            assigned_to:        '<?php echo e($assignedUserId); ?>',
            address:            <?php echo json_encode($lead->address ?? '', 15, 512) ?>,
            city:               '<?php echo e(addslashes($lead->city ?? '')); ?>',
            state:              '<?php echo e(addslashes($lead->state ?? '')); ?>',
            country:            '<?php echo e(addslashes($lead->country ?? 'India')); ?>',
            zip_code:           '<?php echo e($lead->zip_code ?? ''); ?>',
            instagram_id:       '<?php echo e(addslashes($lead->instagram_id ?? '')); ?>',
            facebook_id:        '<?php echo e(addslashes($lead->facebook_id ?? '')); ?>',
            google_profile:     '<?php echo e(addslashes($lead->google_profile ?? '')); ?>',
            website:            '<?php echo e(addslashes($lead->website ?? '')); ?>',
            priority:           '<?php echo e($lead->priority ?? 'medium'); ?>',
            description:        <?php echo json_encode($lead->description ?? '', 15, 512) ?>,
            next_followup_at:   '<?php echo e($followupFormatted); ?>',
            tags:               <?php echo json_encode($selectedTagIds); ?>,
        },
        ...
        async submit() {
            ...
            try {
                const res  = await fetch('/admin/crm/leads/<?php echo e($lead->id); ?>', {
                    method:  'PUT',
                    headers: {
                ...
                setTimeout(() => {
                    window.location.href = '<?php echo e(route("admin.crm.leads.show", $lead->id)); ?>';
                }, 900);
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/crm/leads/edit.blade.php ENDPATH**/ ?>