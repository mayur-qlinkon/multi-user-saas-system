...
<div class="w-full">
    ...
    <div class="relative group">
        <select name="<?php echo e($name); ?>" id="<?php echo e($name); ?>" <?php echo e($required ? 'required' : ''); ?>
            ...
            <?php $__currentLoopData = $methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option :value="<?php echo e($method->id); ?>" data-slug="<?php echo e($method->slug); ?>"
                    data-online="<?php echo e($method->is_online); ?>" <?php echo e(old($name, $selected) == $method->id ? 'selected' : ''); ?>>
...
<?php if (! $__env->hasRenderedOnce('3baa482f-6756-454f-8682-2f6b53a18f62')): $__env->markAsRenderedOnce('3baa482f-6756-454f-8682-2f6b53a18f62'); ?>
    <script>
...
<?php endif; ?>
<?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/components/payment-method-select.blade.php ENDPATH**/ ?>