                ...
                <div class="p-6 sm:p-8">
                    ...
                    <div x-show="activeTab === 'storefront'" x-cloak x-transition:enter="transition ease-out duration-150"
                        ...
                        <div class="p-3 bg-blue-50 border border-blue-100 rounded-xl mb-5 flex gap-2">
                            ...
                            <a href="<?php echo e(route('admin.stores.index')); ?>" class="underline font-semibold">Stores → Edit Branch → Public Page</a>.</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
                           ...
                           <div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea name="business_hours" rows="3" placeholder="e.g., Mon-Fri: 9 AM - 6 PM&#10;Sat-Sun: Closed" class="field-input resize-y"><?php echo e(get_setting('business_hours')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/settings.blade.php ENDPATH**/ ?>