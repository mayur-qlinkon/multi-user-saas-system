                    ...
                    <div class="p-4 hover:bg-gray-50/50 transition-colors flex flex-col gap-3">
                        ...
                        <div class="flex justify-between items-start gap-2">
                            <div class="flex items-center gap-3 min-w-0">
                                <div class="w-10 h-10 rounded-full text-white flex items-center justify-center text-sm font-bold shrink-0" style="background: <?php echo e($avatarBg); ?>">
                                    <?php echo e($initials); ?>

                                </div>
                                <div class="min-w-0">
                                    <p class="font-bold text-[14px] text-gray-900 truncate"><?php echo e($empName); ?></p>
                                    <p class="text-[11px] text-gray-500 mt-0.5 truncate"><?php echo e($empCode ?: '—'); ?></p>
                                </div>
                            </div>
                            <div class="shrink-0">
                                <span class="status-badge px-2 py-0.5 text-[9px] flex items-center gap-1" style="background: <?php echo e($sColor['bg']); ?>; color: <?php echo e($sColor['text']); ?>">
                        ...
                        <div class="flex flex-col gap-2 bg-gray-50/80 px-3 py-2.5 rounded-lg border border-gray-100">
                            <div class="flex justify-between items-center">
                                <span class="text-[12px] font-bold text-gray-800"><?php echo e($leave->leaveType?->name ?? '—'); ?></span>
                                <span class="text-[11px] font-bold text-gray-700">
                                    <?php echo e($leave->total_days); ?> Day(s) <span class="text-gray-400 font-medium ml-1">(<?php echo e($dayTypeLabels[$leave->day_type] ?? ucfirst(str_replace('_', ' ', $leave->day_type ?? '—'))); ?>)</span>
                                </span>
                            </div>
                            <div class="flex items-center justify-between pt-1 border-t border-gray-100/50 mt-1">
                                <span class="text-[11px] text-gray-500 font-medium">
                                    <span class="text-[9px] font-bold text-gray-400 uppercase tracking-wider">From:</span> <?php echo e($leave->from_date?->format('d M y')); ?>

                                </span>
                                <i data-lucide="arrow-right" class="w-3 h-3 text-gray-300"></i>
                                <span class="text-[11px] text-gray-500 font-medium">
                                    <span class="text-[9px] font-bold text-gray-400 uppercase tracking-wider">To:</span> <?php echo e($leave->to_date?->format('d M y')); ?>
                        ...
                        <div class="flex items-center justify-between pt-1 border-t border-gray-50 mt-1">
                            <span class="text-[10px] text-gray-400 font-medium">Applied: <?php echo e($leave->created_at?->format('d M Y')); ?></span>
                            <div class="flex items-center justify-end gap-2">
                                <?php if(has_permission('leaves.view')): ?>
                                    <a href="<?php echo e(route('admin.hrm.leaves.show', $leave->id)); ?>" class="w-8 h-8 flex items-center justify-center rounded-lg border border-gray-200 text-gray-600 hover:bg-blue-50 hover:text-blue-600 hover:border-blue-100 transition-colors" title="View">
                                        <i data-lucide="eye" class="w-4 h-4"></i>
                                    </a>
                                <?php endif; ?>

                                <?php if($leave->status === 'pending' && has_permission('leaves.approve')): ?>
                                    <button @click="handleAction(<?php echo e($leave->id); ?>, 'reject')" class="w-8 h-8 flex items-center justify-center rounded-lg border border-red-200 bg-red-50 text-red-500 hover:bg-red-100 hover:text-red-600 transition-colors" title="Reject">
                                        <i data-lucide="x" class="w-4 h-4"></i>
                                    </button>
                                    
                                    <button @click="handleAction(<?php echo e($leave->id); ?>, 'approve')" class="w-8 h-8 flex items-center justify-center rounded-lg border border-green-200 bg-green-50 text-green-600 hover:bg-green-100 hover:text-green-700 transition-colors" title="Approve">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/hrm/leaves/index.blade.php ENDPATH**/ ?>