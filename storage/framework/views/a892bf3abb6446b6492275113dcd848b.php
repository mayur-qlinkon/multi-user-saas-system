                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                            ...
                            <div class="mt-6 pt-4 border-t border-gray-200">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $expense->activities->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="flex justify-between items-start text-sm py-2 border-b border-gray-100 last:border-0">
                                        <div>
                                            <span class="font-medium text-gray-800"><?php echo e($activity->description); ?></span>
                                            <?php if($activity->properties->count() && is_super_admin()): ?>
                                                <div class="mt-1.5">
                                                    <button type="button" @click="openAuditModal('<?php echo e($activity->description); ?>', <?php echo e($activity->properties->toJson()); ?>)"
                                        ...
                                        <div class="text-right text-[11px] text-gray-400">
                                            <?php echo e($activity->causer?->name ?? 'System'); ?><br>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/expenses/show.blade.php ENDPATH**/ ?>