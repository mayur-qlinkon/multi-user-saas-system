...
<?php $__env->startSection('title', 'Categories - Qlinkon BIZNESS'); ?>

<?php $__env->startSection('header-title'); ?>
    <h1 class="text-sm font-bold text-gray-500 uppercase tracking-widest">Category / Products</h1>
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="flex flex-col md:table-row border-b md:border-b-0 border-gray-100 p-4 md:p-0 hover:bg-gray-50/50 transition-colors relative"
                                x-show="matchesSearch('<?php echo e(strtolower($category->name)); ?>')">
                                <td class="block md:table-cell px-0 py-2 md:px-6 md:py-4 w-full md:w-auto">
                                    ...
                                    <span class="font-bold text-[#475569] text-[15px] md:text-[13.5px] pr-20"><?php echo e($category->name); ?></span>
                                </td>
                                ...
                                <td class="absolute top-4 right-4 md:relative md:top-auto md:right-auto block md:table-cell px-0 py-0 md:px-6 md:py-4 w-auto">
                                    <div class="flex items-center justify-end gap-2.5">
                                        ...
                                        <button
                                            @click="openEditModal(<?php echo e($category->toJson()); ?>, '<?php echo e($category->image_url); ?>')"
    ...
    <script>
        function categoryCrud() {
            return {
                ...
                isModalOpen: false,
                modalMode: 'create',
                formAction: '<?php echo e(route('admin.categories.store')); ?>',
                imagePreview: null,
                formData: {
                    name: '',
                    slug: '',
                ...
                openCreateModal() {
                    ...
                    this.formAction = '<?php echo e(route('admin.categories.store')); ?>';
                    this.formData = {
                        name: '',
                        slug: '',
                        is_active: true
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/products/categories.blade.php ENDPATH**/ ?>