                                ...
                                <tr class="table-row group">
                                    ...
                                    <td class="px-4 py-3.5 text-right">
                                        <p class="text-[14px] font-black text-gray-900">
                                            <?php echo e($expense->currency_code); ?> <?php echo e(number_format($expense->total_amount, 2)); ?>

                                        </p>
                                        <?php if($expense->tax_amount > 0): ?>
                                            <p class="text-[10px] font-semibold text-gray-400 mt-0.5"
                                                title="Base: <?php echo e(number_format($expense->base_amount, 2)); ?> + Taxes">
                                                Includes Tax
                                            </p>
                                        <?php else: ?>
                                    ...
                                    <td class="px-4 py-3.5 text-center">
                                        <span
                                            ...
                                            style="background: <?php echo e($payConf['bg']); ?>; color: <?php echo e($payConf['text']); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/expenses/index.blade.php ENDPATH**/ ?>