            ...
            <table class="w-full">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="table-row" x-show="matchesSearch('<?php echo e(strtolower($rule->name)); ?>')">
                            <td class="px-5 py-3 text-[12px] font-bold text-gray-400"><?php echo e($rules->firstItem() + $loop->index); ?></td>
                            <td class="px-5 py-3">
                                <div>
                            ...
                            <td class="px-3 py-3">
                                <span class="text-[11px] font-bold text-gray-500 bg-gray-100 px-2 py-0.5 rounded"><?php echo e(\App\Models\Hrm\AttendanceRule::TYPE_LABELS[$rule->rule_type] ?? $rule->rule_type); ?></span>
                            </td>
                            <td class="px-3 py-3 text-center">
                                <span class="text-[12px] font-bold text-gray-700"><?php echo e($rule->threshold_count); ?> per <?php echo e($rule->threshold_period); ?></span>
                            </td>
                            <td class="px-3 py-3 text-center">
                                <span class="text-[11px] font-bold text-indigo-700 bg-indigo-50 border border-indigo-200 px-2 py-0.5 rounded"><?php echo e(\App\Models\Hrm\AttendanceRule::ACTION_LABELS[$rule->action] ?? $rule->action); ?></span>
                            </td>
                            <td class="px-3 py-3 text-center">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/hrm/attendance-rules/index.blade.php ENDPATH**/ ?>