...
<?php $__env->startSection('title', 'Process Return - Qlinkon BIZNESS'); ?>

<?php $__env->startSection('header-title'); ?>
    <h1 class="text-sm font-bold text-gray-500 uppercase tracking-widest">Inventory / Process Return / <?php echo e($challan->challan_number); ?></h1>
...
<?php $__env->startSection('content'); ?>
    <div class="pb-20" x-data="returnForm(<?php echo \Illuminate\Support\Js::from($challan->items)->toHtml() ?>)">
        
        
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                <h1 class="text-[1.5rem] font-bold text-[#212538] tracking-tight mb-1">Process Goods Return</h1>
                <p class="text-sm text-gray-500 font-medium">Returning goods against <?php echo e($challan->type_label); ?> #<strong class="text-gray-800"><?php echo e($challan->challan_number); ?></strong></p>
            </div>
        ...
        <form id="mainReturnForm" action="<?php echo e(route('admin.challan-returns.store')); ?>" method="POST"
            ...
            <div class="bg-gray-50 rounded-lg shadow-sm border border-gray-200 mb-6 p-6 grid grid-cols-1 md:grid-cols-4 gap-6">
                <div>
                    ...
                    <div class="text-sm font-bold text-gray-800"><?php echo e($challan->party_name ?: 'Unknown Party'); ?></div>
                    <?php if($challan->party_phone): ?>
                        <div class="text-xs text-gray-500 mt-0.5"><?php echo e($challan->party_phone); ?></div>
                    <?php endif; ?>
                </div>
                <div>
                    <div class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Dispatched From</div>
                    <div class="text-sm font-bold text-gray-800"><?php echo e($challan->store->name ?? 'N/A'); ?></div>
                    <div class="text-xs text-gray-500 mt-0.5">Warehouse: <?php echo e($challan->warehouse->name ?? 'Primary'); ?></div>
                </div>
                <div>
                    <div class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Challan Date</div>
                    <div class="text-sm font-bold text-gray-800"><?php echo e($challan->challan_date->format('d M Y')); ?></div>
                </div>
                <div>
                    <div class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Expected Return</div>
                    <div class="text-sm font-bold <?php echo e($challan->is_return_overdue ? 'text-red-600' : 'text-gray-800'); ?>">
                        <?php echo e($challan->return_due_date ? $challan->return_due_date->format('d M Y') : 'N/A'); ?>

                        <?php if($challan->is_return_overdue): ?>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="received_by" value="<?php echo e(auth()->user()->name); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/challan-returns/create.blade.php ENDPATH**/ ?>