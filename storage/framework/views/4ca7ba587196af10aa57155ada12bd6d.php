...
<?php $__env->startSection('meta_description', $page->seo_description ?? "Read the {$page->title} for {$company->name}."); ?>
...
<div class="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
    ...
    <div class="text-center mb-12 pb-8 border-b border-gray-100">
        ...
        <p class="text-sm text-gray-500 font-medium uppercase tracking-widest">
            Last updated on <?php echo e($page->updated_at->format('F j, Y')); ?>
...
<?php echo $__env->make('layouts.storefront', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/storefront/page.blade.php ENDPATH**/ ?>