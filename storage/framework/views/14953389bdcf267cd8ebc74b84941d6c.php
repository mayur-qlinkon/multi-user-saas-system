        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="detail-card">
                <div class="flex items-center justify-between mb-4 flex-wrap gap-3">
                    ...
                    <div class="flex items-center gap-2 flex-wrap">
                        ...
                        <?php if($order->invoice): ?>
                            <a href="<?php echo e(route('admin.invoices.show', $order->invoice->id)); ?>"
                ...
                <div class="flex flex-wrap gap-2 pt-3 border-t border-gray-100">
                    ...
                    <?php if(!$order->invoice_id && !in_array($order->status, ['cancelled', 'failed']) && has_permission('invoices.create')): ?>
                        <a href="<?php echo e(route('admin.invoices.create', ['order_id' => $order->id])); ?>"
                            class="action-btn action-btn-primary"
            ...
            <div class="detail-card !p-0 overflow-hidden">
                ...
                <div class="items-table-header text-[10px] font-black text-gray-400 uppercase tracking-widest"
                    style="<?php echo e($order->order_type === 'inquiry' ? 'grid-template-columns: 3fr 1fr;' : ''); ?>">
                    <span>Product</span>
            ...
            <div class="detail-card">
                    ...
                    <div class="space-y-0">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value">
                                ...
                                <span class="status-badge text-[11px] px-2 py-0.5"
                                    style="background: <?php echo e($isc['bg']); ?>; color: <?php echo e($isc['text']); ?>">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value capitalize text-xs text-gray-500">
                                <?php echo e(ucfirst($order->invoice->payment_status)); ?>

                            </span>
                        </div>
                        <?php if($order->invoice->grand_total > 0): ?>
                            <div class="info-row">
                                <span class="info-label">Amount</span>
                                <span class="info-value font-mono">₹<?php echo e(number_format($order->invoice->grand_total, 2)); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                    <a href="<?php echo e(route('admin.invoices.show', $order->invoice->id)); ?>"
                ...
                <?php else: ?>
                    <div class="flex flex-col items-center gap-3 py-3">
                        ...
                        <?php if(!in_array($order->status, ['cancelled', 'failed']) && has_permission('invoices.create')): ?>
                            <a href="<?php echo e(route('admin.invoices.create', ['order_id' => $order->id])); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>