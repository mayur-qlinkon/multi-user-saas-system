                ...
                <div class="flex flex-wrap gap-2 pt-3 border-t border-gray-100">
                   ...
                   <a href="<?php echo e(route('admin.orders.receipt', $order->id)); ?>"
                    ...
                    <?php if(has_permission('orders.record_payment')): ?>
                        <?php if($order->payment_status !== 'paid' && $order->total_amount > 0): ?>
                        ...
                        <?php elseif($order->total_amount <= 0): ?>
...
function orderShow() {
    return {
        ...
        payAmount:     '<?php echo e(number_format(max(0, $order->total_amount - $order->payments()->where("status", "completed")->sum("amount")), 2, ".", "")); ?>',
        maxAmount:     <?php echo e(max(0, $order->total_amount - $order->payments()->where("status", "completed")->sum("amount"))); ?>,
        payMethodId:   '',
        payReference:  '',
        payNotes:      '',
