                    ...
                    <div class="p-4 hover:bg-gray-50/50 transition-colors flex flex-col gap-3">
                        ...
                        <div class="flex justify-between items-start gap-2">
                            ...
                            <div class="text-right shrink-0">
                                <span class="font-black text-[#108c2a] text-[15px]">₹<?php echo e(number_format($return->grand_total, 2)); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-2 bg-gray-50/80 px-3 py-2.5 rounded-lg border border-gray-100">
                            <div class="flex justify-between items-center">
                                <a href="<?php echo e(route('admin.invoice-returns.show', $return->id)); ?>" class="font-extrabold text-gray-900 text-[13px] hover:underline">
                                    <?php echo e($return->credit_note_number); ?>
                            ...
                            <div class="flex flex-wrap items-center gap-2 pt-1 border-t border-gray-100/50">
                                <a href="<?php echo e(route('admin.invoices.show', $return->invoice_id)); ?>" class="text-[10px] text-blue-600 hover:text-blue-800 font-bold uppercase tracking-wider">
                                    Inv: <?php echo e($return->invoice->invoice_number ?? 'Unknown'); ?>

                                </a>
                                <span class="text-gray-300">|</span>
                                <span class="text-[9px] font-black uppercase tracking-widest <?php echo e($tColor); ?>">
                                    <?php echo e(str_replace('_', ' ', $return->return_type)); ?>

                                </span>
                                <span class="px-1.5 py-0.5 rounded text-[9px] font-extrabold uppercase tracking-wider border <?php echo e($sColor); ?> ml-auto">
                                    <?php echo e($return->status); ?>
                        ...
                        <div class="flex items-center justify-end gap-2 pt-1">
                            <?php if(has_permission('invoice_returns.view')): ?>
                                <a href="<?php echo e(route('admin.invoice-returns.show', $return->id)); ?>" class="w-8 h-8 rounded-lg border border-gray-200 text-gray-600 hover:bg-gray-50 flex items-center justify-center transition-colors" title="View Credit Note">
                                    <i data-lucide="eye" class="w-4 h-4"></i>
                                </a>
                            <?php endif; ?>
                            ...
                            <?php if($return->status === 'draft'): ?>
                                <?php if(has_permission('invoice_returns.update')): ?>
                                    <a href="<?php echo e(route('admin.invoice-returns.edit', $return->id)); ?>" class="w-8 h-8 rounded-lg border border-blue-200 text-blue-500 hover:bg-blue-50 flex items-center justify-center transition-colors" title="Edit Draft">
                                        <i data-lucide="pencil" class="w-4 h-4"></i>
                                    </a>
                                <?php endif; ?>

                                <?php if(has_permission('invoice_returns.delete')): ?>
                                    <form action="<?php echo e(route('admin.invoice-returns.destroy', $return->id)); ?>" method="POST" class="inline-block" onsubmit="event.preventDefault(); BizAlert.confirm('Delete Draft?', 'Are you sure you want to delete this draft credit note?').then((result) => { if(result.isConfirmed) this.submit(); });">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/invoice-returns/index.blade.php ENDPATH**/ ?>