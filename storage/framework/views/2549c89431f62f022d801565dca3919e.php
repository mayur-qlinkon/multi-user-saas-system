<?php $__env->startSection('title', 'Add New Lead'); ?>
                            ...
                            <select x-model="form.crm_pipeline_id"
                                ...
                                <?php $__currentLoopData = $pipelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pipeline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($pipeline->id); ?>"
                                        <?php echo e($pipeline->is_default ? 'selected' : ''); ?>>
...
function createLeadPage() {
    return {
        ...
        form: {
            ...
            company_name:       '',
            lead_value:         '',
            crm_pipeline_id: '<?php echo e($defaultPipelineId); ?>',
            crm_stage_id:       '',
            crm_lead_source_id: '',
            assigned_to:        '',
            address:            '',
        ...
        async submit() {
            ...
            try {
                const res  = await fetch('<?php echo e(route("admin.crm.leads.store")); ?>', {
                    method:  'POST',
                    headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlink-saas - Slug Based\resources\views/admin/crm/leads/create.blade.php ENDPATH**/ ?>