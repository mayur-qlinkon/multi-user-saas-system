...
<?php $__env->startSection('title', 'Edit Order - Qlinkon BIZNESS'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="pb-20" x-data="orderForm(<?php echo \Illuminate\Support\Js::from($warehouses->where('is_default', 1)->pluck('id', 'store_id'))->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($order)->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($order->items)->toHtml() ?>)">
        
        
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                <div class="flex items-center gap-3 mb-1">
                    <h1 class="text-[1.5rem] font-bold text-gray-500 uppercase tracking-widest">Edit Order #<?php echo e($order->order_number); ?></h1>
        ...
        <form id="mainOrderForm" action="<?php echo e(route('admin.orders.update', $order->id)); ?>" method="POST" @submit="BizAlert.loading('Updating Order...')">
            <?php echo csrf_field(); ?>
    ...
    function orderForm(storeDefaults={}, initialOrder, initialItems) {
        ...
        return {
            ...
            formData: { 
                ...
                store_id: '<?php echo e(session("store_id")); ?>' || initialOrder.store_id,
                ...
                warehouse_id: ('<?php echo e(session("store_id")); ?>' == initialOrder.store_id) ? (initialOrder.warehouse_id || '') : '',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\qlinkonSoftware\resources\views/admin/orders/edit.blade.php ENDPATH**/ ?>